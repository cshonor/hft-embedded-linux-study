...
→ [15 SysPerf §3.2 O(1)→CFS](../../../../16-systems-performance/chapter-03-operating-systems/notes/section-3.2-内核基础与核心概念.md)
...
> ↔ [ULK Ch7 §1 本章定位](../../../../20-linux-kernel-deep/chapter-07-process-scheduling/notes/section-1-本章定位.md)
---
