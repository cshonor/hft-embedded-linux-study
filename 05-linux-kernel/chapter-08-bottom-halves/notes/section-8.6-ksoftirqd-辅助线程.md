...
→ [Ch 8.3](section-8.3-软中断.md) softirq · [§1.5 SysPerf IRQ/softirq 同核](../../../06.6-systems-performance/chapter-01-intro/notes/section-1.5-排障案例与性能挑战.md) · [Ch 4](../../chapter-04-process-scheduling/) 调度与 nice
