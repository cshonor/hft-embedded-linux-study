...
→ [Ch 8 softirq per-CPU](../../chapter-08-bottom-halves/) · [Ch 10 preempt_disable](../../chapter-10-kernel-synchronization/) · [06 Gorman Slab per-CPU cache](../../../../09-linux-mm/chapter-08-slab-allocator/notes/section-5-每-CPU-对象缓存.md)
