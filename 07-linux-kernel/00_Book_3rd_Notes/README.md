...
> **笔记只在** `chapter-XX/notes/section-*.md` **体系内**（拓展节标「拓展」）。勿再依赖仓库根下独立散页。
...
**全书 20 章笔记 ✓**（2025 迁移为与 [14-Systems-Performance](../../19-systems-performance/) 同构目录）
...
选读补上下文：**Ch 3、12、15** · 内存深读 → [09-linux-mm](../../09-linux-mm/)

对照性能观测 → [19-systems-performance](../../19-systems-performance/) Ch 3 / 6–10
