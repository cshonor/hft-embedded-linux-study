...
→ [§3.2 task_struct](./section-3.2-进程描述符与任务结构.md) · [Ch 4 §4.6 RT](../../chapter-04-process-scheduling/notes/section-4.6-实时调度策略.md) · [07 TLPI Ch29 线程](../../../../04-linux-userspace-api/chapter-29-threads-intro/notes.md) · [07 TLPI Ch30 线程同步](../../../../04-linux-userspace-api/chapter-30-thread-synchronization/notes.md)
