...
> **读 go-dex 撮合引擎？** 先从 **[§1 散户股票交易](./notes/section-1-1-散户股票交易.md#与-go-dex理解订单簿的最好切入点)** 入手。**机构大单三条路：** [§2 暗池/拆单](./notes/section-2-2-机构股票交易.md) · [§3 OTC 折扣](./notes/section-3-3-超大宗股票抛售.md#暗池-vs-otc-vs-公开簿三种大单出路)（与暗池互补）。
...
| 本章总结：七个故事 → 全书概念地图 | [notes/section-8-本章总结-七个故事-全书概念地图.md](./notes/section-8-本章总结-七个故事-全书概念地图.md) |

---

## 相关章节

- 上一章：[chapter-01-introduction-market-microstructure](../chapter-01-introduction-market-microstructure/)
- 下一章：[chapter-03-trading-industry](../chapter-03-trading-industry/)
