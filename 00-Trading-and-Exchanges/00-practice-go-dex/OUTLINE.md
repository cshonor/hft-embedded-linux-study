...
| **目标** | **暗池**、**OTC/upstairs 协商成交**、**冰山单**、**多 ingress**、**SOR**、**风控**、**算法拆单** |
| **理论** | [Ch 2 §2 机构](../chapter-02-trading-stories/notes/section-2-2-机构股票交易.md) · [§3 OTC 折扣](../chapter-02-trading-stories/notes/section-3-3-超大宗股票抛售.md) |
| **验收** | 暗池成交不出现在公开 LOB；**OTC** 成交写入账本但不 walk 公开簿；SOR / 拆单 impact 低于单笔市价 |
