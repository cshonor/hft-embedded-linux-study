...
| 4. 交易市场的分布 (Where are the Trading Markets?) | [notes/section-4-4-交易市场的分布.md](./notes/section-4-4-交易市场的分布.md) — **资产类别 vs 第一–四市场渠道** · 两维矩阵 |
| 5. 市场监管 (Market Regulation) | [notes/section-5-5-市场监管.md](./notes/section-5-5-市场监管.md) |
| 本章总结 | [notes/section-6-本章总结.md](./notes/section-6-本章总结.md) |

---

## 相关章节

- 上一章：[chapter-02-trading-stories](../chapter-02-trading-stories/)
- 下一章：[chapter-04-orders-and-order-types](../chapter-04-orders-and-order-types/)
