...
> 读序：本书 → [MELP](../mastering-embedded-linux-programming/) · 重合说明：[FOUR-BOOKS-OVERLAP](../FOUR-BOOKS-OVERLAP.md)
...
| 1.4 Standards…（LSB / LF / CGL / Moblin / SA Forum） | LSB **工程可忘掉**（见 [TLPI Ch1](../../07-The-Linux-Programming-Interface/chapter-01-introduction/)）；其余了解 | 速览 |
| 1.5 Summary | — | — |
...
→ **深入交给 [21 LDD3 + Madieu](../../21-Linux-Device-Driver/)**，此处勿当驱动主教材。
...
然后进 [MELP OUTLINE](../mastering-embedded-linux-programming/OUTLINE.md) 动手；启动/rootfs 已懂可跳 MELP 重复章。
