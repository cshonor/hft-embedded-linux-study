...
> 对应路线：[HFT-READING-ROADMAP §嵌入式](../HFT-READING-ROADMAP.md#六嵌入式-linux-支线19–23) · 模块 [20 构建](./README.md) · [21 驱动](../21-Linux-Device-Driver/README.md)  
...
内核属 **5.x+** → LDD3 用来理解驱动模型；实现与设备树跟 **D**（及 [21 驱动/DT](../21-Linux-Device-Driver/)）。
