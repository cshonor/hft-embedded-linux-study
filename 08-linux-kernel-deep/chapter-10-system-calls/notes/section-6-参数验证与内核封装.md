...
| 用户态编程 | [08 TLPI](../../../04-linux-userspace-api/) |
| LKD 对照 | Linux Kernel Development Ch 5 |
| vDSO / 无 syscall 计时 | [16 HFT 工程](../../../21-hft-engineering/) · modern kernel `vdso(7)` |
...
> ↔ [LKD Ch05 §5.4 实现与参数验证](../../../07-linux-kernel/00_Book_3rd_Notes/chapter-05-system-calls/notes/section-5.4-实现与参数验证.md)
