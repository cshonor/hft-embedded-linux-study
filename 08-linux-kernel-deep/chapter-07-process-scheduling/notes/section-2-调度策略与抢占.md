...
→ HFT 热路径常用 **`SCHED_FIFO`** + 绑核 → [16 HFT](../../../21-hft-engineering/) · [Ch 6 syscall](./section-6-调度相关系统调用.md)
...
> ↔ [LKD Ch04 §4.6 实时调度策略](../../../07-linux-kernel/00_Book_3rd_Notes/chapter-04-process-scheduling/notes/section-4.6-实时调度策略.md)
> ↔ [LKD Ch04 §4.5 抢占与上下文切换](../../../07-linux-kernel/00_Book_3rd_Notes/chapter-04-process-scheduling/notes/section-4.5-抢占与上下文切换.md)
> ↔ [LKD Ch04 §4.2 调度策略](../../../07-linux-kernel/00_Book_3rd_Notes/chapter-04-process-scheduling/notes/section-4.2-调度策略.md)
