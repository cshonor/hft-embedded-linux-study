...
→ 深潜：[Ch 10 系统调用](../chapter-10-system-calls.md) · [08 TLPI](../../../04-linux-userspace-api/)
...
> ↔ [LKD Ch07 §7.6 中断处理机制的实现](../../../07-linux-kernel/00_Book_3rd_Notes/chapter-07-interrupts/notes/section-7.6-中断处理机制的实现.md)
