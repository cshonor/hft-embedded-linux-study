...
→ 深化：[chapter-04 硬件](./chapter-04-硬件选型与服务器配置.md) · [chapter-05 OS 调优](./chapter-05-操作系统内核极致调优.md) · [15-DPDK](../14-dpdk/)
...
→ 深化：[chapter-06 网络与协议](./chapter-06-低延迟网络与协议优化.md) · [22-markets-microstructure](../22-markets-microstructure/)
...
| [22-markets-microstructure](../22-markets-microstructure/) | 微观结构 · 订单簿理论 |
