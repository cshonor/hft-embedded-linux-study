...
16 MMIO 外设
   ↓
（选读 14–15 异常概念）→ [奔跑吧 ARM64 主书](../aarch64-practice/) → 开 20 U-Boot / 21 驱动
```
...
| [08 MikanOS](../05-os-from-scratch/mikanos/) x86 UEFI | **Ch16 MMIO** ≈ GOP 写帧缓冲 · **Ch13/18** ≈ Loader 调内核 |
| [04 LKD](../07-linux-kernel/) 中断 | **Ch14–15** 异常概念 → [奔跑吧 Ch11–13](../aarch64-practice/chapter-11-exception-handling/) |

---

← [19 README](../README.md) · [奔跑吧 ARM64 OUTLINE](../aarch64-practice/OUTLINE.md) · 下一模块 [20 构建](../11-embedded-boot-build/)
