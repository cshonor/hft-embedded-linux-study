...
| 已学 / 将学 | Ch1 呼应 |
|-------------|----------|
| [01 CSAPP](../../../../02-computer-systems/) 机器级 | 另一 ISA，同一「表示 + 调用约定」层 |
| [03 Hennessy](../../../../03-computer-architecture/) | 微架构在 ISA 之下；RISC 流水线 |
| [08 MikanOS](../../../../05-os-from-scratch/mikanos/) | 也是「比特进内存 → CPU 从入口跑」 |
| [奔跑吧 ARM64](../../../aarch64-practice/) | Cortex-**A** + AArch64 主战场 |
| [20 构建](../../../../11-embedded-boot-build/) | 同一工具链概念，尺度变为内核/根文件系统 |
