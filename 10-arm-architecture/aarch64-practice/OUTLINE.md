...
|------|------|
| **精读** | 嵌入式 Linux / 飞控支线必看 |
| **选读** | 与 [03 Hennessy](../../03-computer-architecture/) Ch2 重叠，可后补 |
| **跳过** | 首遍可略（SVE 等） |
...
| **9** | 链接器与链接脚本 | **精读** | [ch09](./chapter-09-linker-scripts/) | 接 [20 构建](../../11-embedded-boot-build/) |
...
| **14** | 内存管理 | **精读** | [ch14](./chapter-14-memory-management/) | 页表 · 接 [06 Gorman](../../09-linux-mm/) |
...
| **21** | 操作系统相关话题 | **精读** | [ch21](./chapter-21-os-topics/) | 进 [20](../11-embedded-boot-build/) / [21 驱动](../../12-device-drivers-dt/) |
| **22** | 浮点与NEON | 选读 | [ch22](./chapter-22-fp-neon/) | 姿态解算可后接 [23](../../14-motion-control/) |
