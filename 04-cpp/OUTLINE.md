...
| **Modern 先于 muduo** | [10 PNP](../12-network-sockets/muduo-sockets/) 是 C++ 工程；**`01-Effective-Modern-C++` 是硬门槛** |
...
**验收：** 能读 muduo 里 `shared_ptr` / 回调 / 移动语义不懵 → 再开 [10 PNP](../12-network-sockets/muduo-sockets/)。
