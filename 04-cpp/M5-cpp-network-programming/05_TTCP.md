...
| 延迟测试 | 小块 + `TCP_NODELAY` + P99/P99.9 分位数统计；进一步见 [15 系统性能](../../14-systems-performance/) |
| 硬件上限 | 万兆网卡线速 1.25GB/s，内核 TCP 大约能到 60-80%，再往上就是 [14 DPDK](../../13-dpdk/) 的领地 |
...
- [02 粘包](./02_TCPByteStream.md)（readn/writen） · [12 TCP/IP 拥塞控制](../../11-tcpip-protocols/) · [15 系统性能](../../14-systems-performance/)
