...
- [条款 2：尽量以 const、enum、inline 替换 #define](item02-尽量以const、enum、inline替换%23define.md)
...
**复习：** → [条款 2：尽量以 const、enum、inline 替换 #define](item02-尽量以const、enum、inline替换%23define.md)
</details>
