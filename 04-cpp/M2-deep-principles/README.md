...
> **里程碑定位：** 🔴 硬门槛 · 开 HFT 前必过
> **学习顺序：** M1 之后、M3 穿插之后（07–11 网络栈进行中或之后、14 HFT 之前）
> **难度：** ⭐⭐⭐⭐⭐
...
- 07：能解释空类 sizeof、多继承 this 调整、虚函数代价、CRTP 静态多态
- 08：能写 mutex/condition_variable、理解 data race、能解释 6 种内存序、SPSC 无锁队列

## 小节笔记结构

每章按小节拆成独立文件，结构同 M1。
- 07：7 章，约 27 个小节
- 08：11 章 + 4 附录，约 87 个小节
