...
> 进程抽象、描述符、切换、创建与销毁 — 理解内核运行机制的核心章
...
- 下一章：[chapter-04-interrupts-and-exceptions/](../chapter-04-interrupts-and-exceptions/)
- 衔接：[chapter-07-process-scheduling.md](../chapter-07-process-scheduling.md) · [chapter-09-process-address-space.md](../chapter-09-process-address-space.md)
