...
| 主题 | 章节 |
|------|------|
| `task_struct` 细节 | [section-3](./section-3-process-descriptor.md) |
| `clone()` 创建线程 | [section-6](./section-6-creation-and-destruction.md) |
| 线程调度 | [Ch 7 进程调度](../../chapter-07-process-scheduling.md) |

---

← [1. 本章定位](./section-1-chapter-scope.md) · 下一节 [3. 进程描述符](./section-3-process-descriptor.md)
