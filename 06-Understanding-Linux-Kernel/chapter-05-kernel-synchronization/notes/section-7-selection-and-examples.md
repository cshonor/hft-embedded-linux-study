...
| 睡眠、唤醒 | [Ch 3 等待队列](../chapter-03-processes/notes/section-4-organization-and-lookup.md) |
...
← [6. 信号量与完成变量](./section-6-semaphores-and-completions.md) · 下一章 [Ch 6 计时](../chapter-06-timing.md)
