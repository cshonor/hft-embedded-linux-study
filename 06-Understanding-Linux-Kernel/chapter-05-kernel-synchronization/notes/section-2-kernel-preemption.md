...
→ 中断上下文规则：[Ch 4](../chapter-04-interrupts-and-exceptions/notes/section-7-softirqs-and-workqueues.md)
...
← [1. 本章定位](./section-1-chapter-scope.md) · 下一节 [3. 基础同步原语](./section-3-basic-primitives.md)
