...
| 特性 | 含义 | 后续深潜 |
|------|------|----------|
| **可抢占内核（Preemptive）** | 内核态也可被更高优先级任务打断，降低调度延迟 | [Ch 7 进程调度](../../chapter-07-进程调度.md) |
| **SMP 支持** | 对称多处理：多 CPU，每颗核可处理任意任务 | [Ch 5 内核同步](../../chapter-05-内核同步.md) · [Ch 7](../../chapter-07-进程调度.md) |
