...
→ 进程页表布局 [section-6](./section-6-memory-layout-and-tlb.md) · 分配物理页 [Ch 8](../../chapter-08-memory-management.md)

---

← [4. 硬件分页](./section-4-hardware-paging.md) · 下一节 [6. 内存布局与 TLB](./section-6-memory-layout-and-tlb.md)
