...
→ Linux 如何在统一框架里适配 → [section-5](./section-5-linux-four-level-paging.md)
...
TLB  miss 时才慢路径查内存中的页表。Linux 如何刷新 TLB → [section-6](./section-6-memory-layout-and-tlb.md)
...
← [3. 分段](./section-3-segmentation.md) · 下一节 [5. Linux 四级分页](./section-5-linux-four-level-paging.md)
