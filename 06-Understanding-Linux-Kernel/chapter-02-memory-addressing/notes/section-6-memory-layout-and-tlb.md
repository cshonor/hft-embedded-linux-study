...
→ 深潜：[Ch 9 进程地址空间](../../chapter-09-process-address-space.md) · [07 Gorman](../../../07-Linux-Virtual-Memory-Manager/)
...
← [5. Linux 四级分页](./section-5-linux-four-level-paging.md) · 下一章 [Ch 3 进程](../../chapter-03-processes.md)
