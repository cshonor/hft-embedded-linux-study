...
→ 中断处理：[Ch 4](../chapter-04-interrupts-and-exceptions/) · SMP APIC 局部 tick [section-3](./section-3-timekeeping-architecture.md)
...
- 设备驱动短延迟 → [section-5](./section-5-software-timers-and-delays.md) `udelay`

---

← [1. 本章定位](./section-1-chapter-scope.md) · 下一节 [3. 计时架构](./section-3-timekeeping-architecture.md)
