...
→ 内核路径：[Ch 10](../chapter-10-system-calls.md) · 用户态：[08 TLPI](../../../08-The-Linux-Programming-Interface/)
...
| 用户态时间 API | [08 TLPI](../../../08-The-Linux-Programming-Interface/) |

---

← [5. 软件定时器](./section-5-software-timers-and-delays.md) · 下一章 [Ch 7 进程调度](../chapter-07-process-scheduling.md)
