...
→ 深潜：[Ch 10 系统调用](../chapter-10-system-calls.md) · [08 TLPI](../../../08-The-Linux-Programming-Interface/)

---

← [2. 分类](./section-2-interrupts-vs-exceptions.md) · 下一节 [4. 控制路径嵌套](./section-4-nested-kernel-paths.md)
