...
> **文件夹 13** · 性能分析方法论。  
> **执行顺序（HFT）：** 建议在 **06 TLPI + 07/01 MikanOS + 08–12 网络/DPDK** 之后、**15 HFT** 之前开读（见 [LEARNING-CHAIN](../LEARNING-CHAIN.md)）。  
> **前置：** [01-CSAPP](../01-CSAPP-3rd/) · [02-Hennessy](../02-Computer-Architecture-6th/) · 最好已有 **03–06** 系统基础  
> **下一本：** [14-BPF](../14-BPF-Performance-Tools/)（紧接 13）  
...
**下一本（紧接）：** [14-BPF-Performance-Tools](../14-BPF-Performance-Tools/) — Ch 15 预览在此展开为 bpftrace/BCC 全书。
