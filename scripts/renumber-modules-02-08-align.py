...
GIT_MV_TO_FINAL = [
    ...
    ("_tmp-renum-03-sysperf", "03-Systems-Performance-2nd"),
    ("_tmp-renum-04-bpf", "04-BPF-Performance-Tools"),
    ("_tmp-renum-06-ulk", "06-Understanding-Linux-Kernel"),
    ("_tmp-renum-07-gorman", "07-Linux-Virtual-Memory-Manager"),
    ("_tmp-renum-08-tlpi", "08-The-Linux-Programming-Interface"),
]
...
PLACEHOLDER_TO_NEW = [
    ("@@MOD06-ULK@@", "06-Understanding-Linux-Kernel"),
    ("@@MOD08-TLPI@@", "08-The-Linux-Programming-Interface"),
    ("@@MOD07-GORMAN@@", "07-Linux-Virtual-Memory-Manager"),
    ("@@MOD02-ARCH@@", "02-Computer-Architecture-6th"),
    ("@@MOD04-BPF@@", "04-BPF-Performance-Tools"),
    ("@@MOD03-SYSPERF@@", "03-Systems-Performance-2nd"),
]
...
PROSE_REPLACEMENTS = [
    ...
    ("05 → 08 ULK", "05 → 06 ULK"),
    ("05 → 08 → 06", "05 → 06 → 07"),
    ("05 → 08 ULK → 06 Gorman → 07 TLPI", "05 → 06 ULK → 07 Gorman → 08 TLPI"),
    ("LKD → 08 ULK", "LKD → 06 ULK"),
    ("LKD → 08 ULK（", "LKD → 06 ULK（"),
    ("05 LKD → 08 ULK", "05 LKD → 06 ULK"),
    ("05 LKD → 08 ULK → 06 Gorman", "05 LKD → 06 ULK → 07 Gorman"),
    ("05 LKD → 08 ULK → 06 Gorman → 07 TLPI", "05 LKD → 06 ULK → 07 Gorman → 08 TLPI"),
    ("`05` LKD → `08` ULK", "`05` LKD → `06` ULK"),
    ("`05` LKD → `08` ULK → `06` Gorman → `07` TLPI", "`05` LKD → `06` ULK → `07` Gorman → `08` TLPI"),
    ...
    ("读序 6–8", "读序 6–8"),
    ("`05`–`08`", "`05`–`08`"),
    ("05–08         09–14", "05–08         09–14"),
    ("内核段：** `05` LKD → `08` ULK → `06` Gorman → `07` TLPI", "内核段：** `05` LKD → `06` ULK → `07` Gorman → `08` TLPI"),
    ("**内核段：** `05` LKD → `08` ULK → `06` Gorman → `07` TLPI", "**内核段：** `05` LKD → `06` ULK → `07` Gorman → `08` TLPI"),
    ("→ [04-Hennessy", "→ [02-Hennessy"),
    ("[04-Hennessy", "[02-Hennessy"),
    ("[02-SysPerf", "[03-SysPerf"),
    ...
    ("→ [07-TLPI", "→ [08-TLPI"),
    ("→ [06-Gorman", "→ [07-Gorman"),
    ("../02-Systems-Performance", "../03-Systems-Performance"),
    ("../03-BPF", "../04-BPF"),
    ("../04-Computer-Architecture", "../02-Computer-Architecture"),
    ("../06-Linux-Virtual", "../07-Linux-Virtual"),
    ("../07-The-Linux", "../08-The-Linux"),
    ("../08-Understanding", "../06-Understanding"),
    ("../../02-Systems-Performance", "../../03-Systems-Performance"),
    ("../../03-BPF", "../../04-BPF"),
    ("../../04-Computer-Architecture", "../../02-Computer-Architecture"),
    ("../../06-Linux-Virtual", "../../07-Linux-Virtual"),
    ...
    ("../../../../07-The-Linux", "../../../../08-The-Linux"),
    ("../../../../08-Understanding", "../../../../06-Understanding"),
    ("[12-HFT](../15-HFT", "[15-HFT](../15-HFT"),  # fix wrong refs if any
    ("下一本：** [02-SysPerf", "下一本：** [03-SysPerf"),
    ("下一本：** [04-Computer", "下一本：** [02-Computer"),
    ("Hennessy 理论 → [04-Computer", "Hennessy 理论 → [02-Computer"),
    ("紧接 [02-SysPerf", "紧接 [03-SysPerf"),
    ("紧接 [02-SysPerf", "紧接 [03-SysPerf"),
    ("Gregg 双书 · 02 → 03", "Gregg 双书 · 03 → 04"),
    ("| **02** | SysPerf | **03** | BPF |", "| **03** | SysPerf | **04** | BPF |"),
    ("| **05** | LKD → **08** ULK |", "| **05** | LKD → **06** ULK |"),
