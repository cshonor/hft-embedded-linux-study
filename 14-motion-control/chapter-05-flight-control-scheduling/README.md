...
| **isolcpus / taskset** | 飞控线程 **独占核** — [05 LKD](../../07-linux-kernel/) |
| **SCHED_FIFO** | RT 调度策略 — 用户态飞控线程 |
| **PREEMPT_RT 补丁** | 内核可抢占 — 降低内核延迟 |
| **cyclictest / perf** | 验证 **周期 jitter p99** — [03 SysPerf](../../19-systems-performance/) |
...
→ [22 无人机实战](../../13-embedded-projects/) · [16 HFT 测量](../../21-hft-engineering/chapter-10-延迟测量与基准压测.md)
