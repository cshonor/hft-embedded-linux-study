...
**文件夹 14** · [返回嵌入式支线](../HFT-READING-ROADMAP.md#六嵌入式-linux-支线10–14)

> **定位：** 无人机项目的 **算法内核** — 只学 **控制逻辑**，**不学** STM32 裸机 / FreeRTOS / PCB。  
> **落地：** 全部依托 **ARM-A + 嵌入式 Linux**（[19–23](../HFT-READING-ROADMAP.md#六嵌入式-linux-支线10–14)）。  
...
> 电机 / ESC 理论：**Ch03** 笔记 + datasheet；驱动实现复用 [20 LDD](../12-device-drivers-dt/)。
...
| HFT | 飞控 |
|-----|------|
| [05 绑核 / SCHED_FIFO](../07-linux-kernel/) | 控制线程 **isolcpus** |
| [03 p99 延迟](../19-systems-performance/) | 控制环 **周期 jitter** |
| [15 无锁环 / 异步日志](../21-hft-engineering/) | 传感器 → 控制 **低延迟路径** |
| [14 零拷贝思想](../18-dpdk/) | 共享内存传 IMU 批次 |
...
**上一章：** [22 嵌入式实战](../13-embedded-projects/) · **总路线：** [HFT-READING-ROADMAP §六](../HFT-READING-ROADMAP.md#六嵌入式-linux-支线10–14)
