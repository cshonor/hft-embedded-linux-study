...
> 章索引：[第 3 章](./README.md) · 前：[3.7 RwLock](../3.7-heap-alloc.md) · 后：[3.9 泄漏与循环引用](legacy-leaks-and-cycles.md)
...
- [3.1 布局](legacy-layout-and-alignment.md) — ZST
- [3.10 MaybeUninit](../3.10-ownership-lifetimes-borrow.md) — 另一类「未持有有效 T」的表示
