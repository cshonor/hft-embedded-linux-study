...
与内核串联：[LKD Ch2 §2.4](../../04-Linux-Kernel-Development/00_Book_3rd_Notes/chapter-02-getting-started/notes/section-2.4-内核开发的特点.md) — 旧内核 `gnu89` = C89+GCC 扩展；现代内核 `gnu11`。读完 K&R 还需补 C99 习惯 + [05 GNU-C](../05-Embedded-C-Self-Cultivation/)。
