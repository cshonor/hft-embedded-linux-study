...
一块 **P型** 和一块 **N型** 在 **原子级融合** 后，接触面形成的结构 = **PN结**（有稳定耗尽层、内建电场）。

> ⚠️ **物理压紧不够：** 两块硅只是宏观贴住、中间有缝隙/氧化层、原子没互相扩散 → **不算合格 PN结**。  
> 工业上靠高温扩散、离子注入+退火，让杂质原子钻进晶格，实现原子层面融合。详见 [补充_PN结到MOS · 收口定稿](./补充_PN结到MOS.md)。
...
| 项 | 方向 / 结果 |
|----|-------------|
| **扩散** | 电子 **N→P**；空穴 **P→N**（浓度驱动） |
| **耗尽层电荷** | 电子离开 N → N侧剩 **正** 施主离子；空穴离开 P → P侧剩 **负** 受主离子 → **N正、P负** |
| **内建电场** | 由正指向负 → **N → P**（⚠️ 不是 P→N） |
| **平衡** | 电场造成 **漂移**（电子往 N 回、空穴往 P 回）与扩散抵消 → 净电流=0 |

> **一句话：** 扩散：电子 N→P；耗尽层：N正、P负；内电场：**N→P**。

#### 联系 N阱（CMOS）

N阱=N区、外围 P衬底=P区 → 大面积 PN结。  
N阱接 **VDD**、P衬底接 **GND** → 外加电场方向 N阱→P（高→低），与 **内建电场 N→P 同向** → **反向偏置** → 耗尽层加宽、几乎无电流 → **电学隔离**。  
详见 [1.7 CMOS · N阱](./1.7_CMOS晶体管.md)。
