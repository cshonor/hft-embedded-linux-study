...
仓库 [mikanos](../../../mikanos/) 对应 **《ゼロからの OS 自作入門》**（**MikanOS**，**x86-64 64 位**）。
...
→ [mikanos Ch1 UEFI 启动流程](../../../mikanos/chapter-01-hello-world/notes/section-5-UEFI启动流程.md)

**学习顺序：**

| 路线 | 建议 |
|------|------|
| **HFT 主线** | **跳过 thirty-days-os**，C 达标后直接 [mikanos](../../../mikanos/) |
