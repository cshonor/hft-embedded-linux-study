...
| | |
|---|---|
| **本章干什么** | **PS/2 或 USB 键盘** 扫描码 → 字符；**GUI 文本框** 与退格。 |
| **全书作用** | **文本输入** — 连接中断 FIFO 与用户可见输入；Ch15 终端、Ch16 命令行的键盘路由前置。 |
| **← 前置** | [Ch11 定时器](../chapter-11-timer-acpi/) + [Ch7 FIFO](../chapter-07-interrupt-fifo/) |
| **→ 后续** | [Ch13 多任务（1）](../chapter-13-multitask1/) — 多个 Task 并发 |
