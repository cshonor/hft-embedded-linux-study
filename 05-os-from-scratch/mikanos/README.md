...
**05-os-from-scratch** 子模块 · [返回 09 总览](../README.md)

> **父模块：** [05-os-from-scratch](../README.md)  
> **原著：** 内田公太（uchan）· **《从零自制操作系统》**（日版 *ゼロからの OS 自作入門*）  
> **本仓库：** HFT 学习链裁剪笔记 + 实验记录（非全书翻译）  
> **HFT 路线定位：** 🔴 **09 模块 OS 动手主线** — C 达标后 **直接从这里开**，不必先做完 [02 30 天](../thirty-days-os/)  
...
| **语言栈** | **C++** + **EDK II**（与 [02 30 天](../thirty-days-os/) 的 32 位 BIOS/C 路线互补） |
...
> **定位：** **现代 64 位 UEFI OS** — **HFT / 服务器底层主线**；与 [02 30 天](../thirty-days-os/)（BIOS 软盘启蒙）**互补但不前置依赖**。
...
**交叉：** [01-CSAPP](../02-computer-systems/) Ch 9 虚拟内存 · [02-Hennessy](../03-computer-architecture/) · [04-linux-userspace-api](../04-linux-userspace-api/) 进程/内存 API 对照。

---

## 目录结构

与 [02 30 天 OS](../thirty-days-os/) · [14-Systems-Performance](../../19-systems-performance/) 一致：每章独立目录，导读 + 分段笔记。
...
| 仓库 | 对照点 |
|------|--------|
| [02 30 天 OS](../thirty-days-os/) | BIOS 实模式 → 保护模式（建议先读 Day 1–15） |
