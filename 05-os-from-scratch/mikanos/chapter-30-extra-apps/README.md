...
| | |
|---|---|
| **本章干什么** | **tview / gview / more** · **窗口关闭按钮** · **cat 建文件** 等综合示例。 |
| **全书作用** | **综合演练** — 把 FS + GUI + IPC + 多终端串成「像小型 OS 发行版」；全书功能验收。 |
| **← 前置** | [Ch21–29 GUI/文件/IPC](../chapter-29-ipc/) |
| **→ 后续** | [Ch31 前方的路](../chapter-31-road-ahead/) — 延伸学习方向 |
