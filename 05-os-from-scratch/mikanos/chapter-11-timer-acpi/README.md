...
| | |
|---|---|
| **本章干什么** | **Local APIC 定时器** · **ACPI PM Timer 校准** · **TimerManager**；毫秒级 **Sleep**。 |
| **全书作用** | **时间基准**（🔴）— 多任务时间片、光标闪烁、Ch13–14 调度都依赖「可信 tick」；衔接 Ch2 ACPI 表概念。 |
| **← 前置** | [Ch10 窗口](../chapter-10-window/) |
| **→ 后续** | [Ch12 键盘](../chapter-12-keyboard/) — 文本输入与 GUI 文本框 |
...
| 与 Linux / CSAPP 对照？ | `jiffies`/hrtimer 雏形 — [07-linux-kernel](../../../07-linux-kernel/) · [ULK 定时](../../../08-linux-kernel-deep/) |
