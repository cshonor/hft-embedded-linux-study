...
| **GNU** | **链接脚本** `.ld`（→ [Ch4 §4.4](../../chapter-04-assembler-rules-directives/notes/section-4-4-directives.md) · [奔跑吧 Ch9](../../../aarch64-practice/chapter-09-linker-scripts/)） |
...
| [20 构建](../../../../08-embedded-boot-build/) | Yocto/Buildroot 打包同一逻辑 |
