...
| | ARM7TDMI (**v4T**) | Cortex-M4 (**v7-M**) | AArch64（[奔跑吧](../../../aarch64-practice/)） |
|---|----------|-----------|--------------------------------------------------------|
...
| [04 LKD](../../../../05-linux-kernel/) | 内核 `entry.S` 保存寄存器帧 ≈ M4 硬件压栈 + 软件扩展 |
| [21 驱动](../../../../09-device-drivers-dt/) | 中断上下文 **不能睡眠** — 从 Handler mode 直觉理解 |
| [20 构建](../../../../08-embedded-boot-build/) | U-Boot 启动时设 **SP、跳 Reset** — 同向量表第一项 |
