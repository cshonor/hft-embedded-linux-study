...
| **9** | 链接器与链接脚本 | **精读** | [ch09](./chapter-09-linker-scripts/) | 接 [20 构建](../../08-embedded-boot-build/) |
...
| **14** | 内存管理 | **精读** | [ch14](./chapter-14-memory-management/) | 页表 · 接 [06 Gorman](../../06-linux-mm/) |
...
| **22** | 浮点与NEON | 选读 | [ch22](./chapter-22-fp-neon/) | 姿态解算可后接 [23](../../11-motion-control/) |
