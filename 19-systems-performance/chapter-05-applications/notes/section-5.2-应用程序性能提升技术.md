...
- 行情：**预分配 mbuf / ring buffer**，热路径零 malloc（→ [13-DPDK 01-Intro ch02](../../../18-dpdk/01-Intro-Book/notes/chapter-02-mbuf与内存池/)）。
...
- 多交易所 TCP 订单通道 → **epoll + 非阻塞**（→ [10-UNP](../../../15-network-sockets/unix-network-api/)）
...
→ [07-linux-kernel](../../../07-linux-kernel/) 调度与绑核 · [12-HFT ch05](../../../21-hft-engineering/chapter-05-操作系统内核极致调优/)
