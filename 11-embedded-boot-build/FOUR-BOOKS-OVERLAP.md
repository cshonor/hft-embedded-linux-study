...
> 对应路线：[HFT-READING-ROADMAP §嵌入式](../HFT-READING-ROADMAP.md#六嵌入式-linux-支线10–14) · 模块 [20 构建](./README.md) · [21 驱动](../12-device-drivers-dt/README.md)  
...
| **C** | *Linux Device Drivers*, 3rd（**LDD3**，2.6） | [21 LDD3 OUTLINE](../12-device-drivers-dt/refs/classic-driver-theory/OUTLINE.md) · [评测](../12-device-drivers-dt/refs/LDD3-EVAL.md) |
| **D** | *Linux Device Drivers Development*（Madieu，成书 4.x） | [21 OUTLINE](../12-device-drivers-dt/refs/modern-driver-practice/OUTLINE.md) · [评测](../12-device-drivers-dt/refs/MADIEU-EVAL.md) |
...
| 覆盖 | 见 [LDD3 OUTLINE](../12-device-drivers-dt/refs/classic-driver-theory/OUTLINE.md) |
| 局限 | **无 DTS**、无 I2C/SPI；API 过时 — **思想精读，代码勿抄** |
| 详评 | [LDD3-EVAL.md](../12-device-drivers-dt/refs/LDD3-EVAL.md) |
...
| 详评 | [MADIEU-EVAL.md](../12-device-drivers-dt/refs/MADIEU-EVAL.md) |
...
内核属 **5.x+** → LDD3 用来理解驱动模型；实现与设备树跟 **D**（及 [21 驱动/DT](../12-device-drivers-dt/)）。
