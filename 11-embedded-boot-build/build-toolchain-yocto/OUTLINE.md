...
> 本目录为 **Simmonds / MELP 实操主线**；建议先读 [Embedded Linux Primer OUTLINE](../primer-system-overview/OUTLINE.md) 再建全局观。  
...
**交叉链接：** Ch 3/4 ↔ [19 ARM64](../../10-arm-architecture/) · Ch 11–12 ↔ [21 驱动+DT](../../12-device-drivers-dt/)
...
**交叉链接：** Ch 17–18 ↔ [07 TLPI](../04-linux-userspace-api/) · [04 LKD](../07-linux-kernel/)
