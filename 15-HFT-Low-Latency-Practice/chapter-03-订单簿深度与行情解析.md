...
→ [chapter-09 策略](./chapter-09-高频做市与套利策略.md) · [chapter-04 共址/硬件](./chapter-04-硬件选型与服务器配置.md)
...
**下一步：** [chapter-04 硬件与共址](./chapter-04-硬件选型与服务器配置.md) · [chapter-05 OS 调优](./chapter-05-操作系统内核极致调优.md)
