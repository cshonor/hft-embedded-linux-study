...
→ 深化：[chapter-08 核心引擎](./chapter-08-超低延迟核心引擎开发.md) · [chapter-02 交易所](./chapter-02-交易所架构与撮合原理.md) · [chapter-03 订单簿](./chapter-03-订单簿深度与行情解析.md)
...
| 原则 | 说明 |
|------|------|
| **GC** | Stop-the-world 致命；Zing / 调优 / 堆外 |
| **Autoboxing** | 避免；**对象池** 复用 |
| **JVM 预热** | JMH / 假订单；Azul **ReadyNow** |

### Python

| 角色 | **研究、回测、编排** — 非 μs 执行路径 |
|------|--------------------------------------|
| **生产** | **C++ 核心 + Cython/Boost.Python/ctypes** 混合 |

→ 深化：[chapter-08 引擎开发](./chapter-08-超低延迟核心引擎开发.md) · [16-Rust](../16-Rust-Quant-Trading-Guide/)
...
→ 深化：[chapter-04 硬件](./chapter-04-硬件选型与服务器配置.md)
...
| 仓库 | 对照 |
|------|------|
| [14-DPDK](../14-DPDK-Low-Latency-Network/) | 用户态网卡 · PMD · 零拷贝 |
| [08-TLPI](../08-The-Linux-Programming-Interface/) | `mmap` · 进程 · 定时 |
| [09-system-low-level-hands-on](../09-system-low-level-hands-on/) | OS/内存/中断体感 |
