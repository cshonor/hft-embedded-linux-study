...
| 与 01 川合 OS 对照？ | 01 **Day 10–12 分页**；Mikan **Ch8 物理帧 + Ch19 进程页表** 拆分 |
| 与 Linux / CSAPP 对照？ | 物理页分配 ≈ **buddy/位图** 极简版 — [CSAPP Ch9](../../../01-CSAPP-3rd/chapter-09-virtual-memory/) · [07 Gorman](../../../07-Linux-Virtual-Memory-Manager/) |
