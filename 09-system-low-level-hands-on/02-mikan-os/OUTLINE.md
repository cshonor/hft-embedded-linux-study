...
> **笔记目录：** 各章独立目录 `chapter-XX-slug/`（导读 `README.md` + `notes/section-*.md`）— 对齐 [01 30 天 OS](../01-30days-os/) 的 `day-XX-slug/` 框架
...
- 第一个 **Hello World**（现代 PC，非 BIOS 软盘）
- 与 [01 Day 1](../01-30days-os/day-01-boot-asm/) 对照：BIOS `0x7C00` vs UEFI 长模式
...
- **协作/抢占多任务** — 对照 [01 Day 15–16](../01-30days-os/day-15-multitask1/)
