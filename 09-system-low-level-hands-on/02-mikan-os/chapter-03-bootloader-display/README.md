...
| 与 01 川合 OS 对照？ | 01 **Day 4–5** 才把引导与内核分离；Mikan **Ch 3 即 ELF 加载 + 图形** |
...
- 对照：[Ch1 PE vs ELF](../chapter-01-hello-world/notes/section-6-C语言过渡与文件格式.md) · [01 Day 4 引导](../../01-30days-os/)
