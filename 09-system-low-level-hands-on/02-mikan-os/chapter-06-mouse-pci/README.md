...
| 与 01 川合 OS 对照？ | 01 多用 **PS/2**；Mikan 直接 **xHCI + PCI** — 更贴近现代 PC |
| 与 Linux / CSAPP 对照？ | PCI/USB 驱动栈极简版 — 对照 [05-LKD PCI](../../../05-Linux-Kernel-Development/) · [ULK 设备驱动](../../../06-Understanding-Linux-Kernel/) |
