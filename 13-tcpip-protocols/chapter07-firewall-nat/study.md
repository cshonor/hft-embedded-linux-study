...
> 前置：[ch05 IP](../chapter05-ip-protocol/study.md) · [ch01 端到端](../chapter01-overview/study.md#ch01-e2e) · 自顶向下：§4.3 NAT
...
→ 精读：[7.3-nat-napt.md](7.3-nat-napt.md) · [速记卡](7.3-nat-napt.md#ch07-3-cheat) · 工作过程
...
- 04_network_layer §4.3 NAT

---

## Top-Down

- study.md §4.3 · 中间盒 §4.5
