...
> 自顶向下对照：06_link_layer_and_lan/study.md
...
→ 自顶向下：§6.3 · 有线：[3.2 CSMA/CD](3.2-ethernet-ieee802-encapsulation.md#ch03-2-mac-evolution)
...
→ 卷1 ch10 UDP + 本书 ch5：ch10 UDP · §3.3 避免 IP 分片
...
→ 精读：[3.10](3.10-link-layer-security.md)（含 **5 条刷题对比表**）· 自顶向下 §8 分层攻击
