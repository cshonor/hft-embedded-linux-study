...
| 4 | mbuf、mempool | [chapter-02-mbuf](./01-Intro-Book/notes/chapter-02-mbuf与内存池.md) | 🔴 |
| 5 | PMD、poll mode | [chapter-03-PMD](./01-Intro-Book/notes/chapter-03-PMD与轮询模式.md) | 🔴 |
| 6 | 零拷贝、旁路 | [chapter-04](./01-Intro-Book/notes/chapter-04-零拷贝与用户态旁路.md) | 🔴 |
| 7 | UDP 组播行情 | [chapter-05](./01-Intro-Book/notes/chapter-05-组播行情接入.md) | 🔴 |
