...
```
Ch7 软件调优 → Ch8 硬件分流 → Ch9 offload（本章）→ 零拷贝/组播落地
```
...
| 内核 offload | [13-LKN](../../../13-Linux-Kernel-Networking/) |
| HFT 网络 | [15 工程](../../../15-HFT-Low-Latency-Practice/) |

---

← [5. DPDK 协同](./section-5-DPDK软件接口与协同.md) · 下一章 [chapter-04 零拷贝](../chapter-04-零拷贝与用户态旁路.md) · [Ch8 流分类](../chapter-08-flow-classification-multiqueue/)
