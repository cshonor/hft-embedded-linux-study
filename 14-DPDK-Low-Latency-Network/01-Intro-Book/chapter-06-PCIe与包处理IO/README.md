...
- 下一章：[chapter-03-PMD与轮询模式.md](../chapter-03-PMD与轮询模式.md) · [chapter-08-流分类与多队列/](../chapter-08-流分类与多队列/)
- 对照：[Ch2 Cache/大页](../chapter-02-Cache与内存/) · [Ch4 无锁 ring](../chapter-04-同步互斥机制/)
