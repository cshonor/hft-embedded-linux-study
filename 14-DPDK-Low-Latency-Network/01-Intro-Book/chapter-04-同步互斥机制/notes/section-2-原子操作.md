...
底层常映射 `__sync_synchronize()` → x86 **`MFENCE`** 等 — 对抗 **指令乱序** 与 **内存弱序**（与 [Ch3 ILP](../chapter-03-并行计算/notes/section-3-指令级并发.md) 对照）。
...
- 内核侧同类原语 → [ULK Ch5 §3 基础同步原语](../../../06-Understanding-Linux-Kernel/chapter-05-kernel-synchronization/notes/section-3-基础同步原语.md)  
- 内存序 / 屏障 → [01-CSAPP](../../../01-CSAPP-3rd/) · [Ch2 Cache 一致性](../chapter-02-Cache与内存/notes/section-4-Cache一致性与无锁设计.md)
