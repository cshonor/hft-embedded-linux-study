...
> **后续：** `05`–`10` 系统纵深 · [11-HFT](../11-HFT-Low-Latency-Practice/) / [12-Rust](../12-Rust-Quant-Trading-Guide/)
...
- 后续内核/内存/网络 → [02-LKD](../05-Linux-Kernel-Development/) · [03-Gorman](../06-Linux-Virtual-Memory-Manager/) · [06-Rosen](../09-Linux-Kernel-Networking/)（读时可回头用 BPF 验证）
- DPDK 对照 → [10-DPDK](../10-DPDK-Low-Latency-Network/)
