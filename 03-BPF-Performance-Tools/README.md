...
> **后续：** `05`–`08` 系统纵深 · [12-HFT](../15-HFT-Low-Latency-Practice/) / [13-Rust](../16-Rust-Quant-Trading-Guide/)
...
与 [01-CSAPP](../01-CSAPP-3rd/) · [02-SysPerf](../02-Systems-Performance-2nd/) 同一套约定。
...
- SysPerf bpftrace 附录 → [02 appendix-C](../02-Systems-Performance-2nd/appendix-C-bpftrace单行命令.md)
- 后续内核/内存/网络 → [05-LKD](../05-Linux-Kernel-Development/) · [06-Gorman](../06-Linux-Virtual-Memory-Manager/) · [13-Rosen](../13-Linux-Kernel-Networking/)（读时可回头用 BPF 验证）
