...
**文件夹 13** · 网络栈闭环 · [返回总清单](../READING-LIST.md#10-dpdk-用户态旁路网络官方文档--本仓库笔记)
...
| 序号 | 文件夹 | 层级 | 回答的问题 |
|------|--------|------|-----------|
| 07 | [TCP/IP Illustrated Vol.1](../11-tcpip-protocols/) | 协议 | 线上包长什么样？ |
| 08 | [UNP Vol.1](../03.5-unix-network-api/) | 系统调用 / Socket API | 用户态怎么调内核网络栈？ |
| 09 | [Linux Kernel Networking](../12-kernel-networking/) | 内核实现 | 内核怎么收发包？ |
...
- 缓存 / 内存 → [02-computer-systems Ch6](../02-computer-systems/chapter-06-memory-hierarchy/)、[15-computer-architecture](../15-computer-architecture/)
- 生产观测 → [06.7-bpf-observability](../06.7-bpf-observability/)
- 工程落地 → [14-hft-engineering](../14-hft-engineering/)
