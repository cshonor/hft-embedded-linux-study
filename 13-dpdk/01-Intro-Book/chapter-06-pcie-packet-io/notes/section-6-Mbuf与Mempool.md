...
> DPDK 为配合底层 I/O 设计的 **包缓冲** 与 **对象池** — 实体书 mbuf 精讲；repo 实验 stub → [chapter-02-mbuf](../../chapter-02-cache-and-memory)
...
对照内核 **sk_buff** → [14-LKN](../../../../12-kernel-networking/) · [Ch1 mbuf 提及](../../chapter-01-dpdk-intro/notes/section-2-硬件平台与DPDK定位.md)
