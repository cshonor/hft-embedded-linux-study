...
| **XDP / tc-BPF** | 内核最早点丢/改包 | 对比 DPDK 的「半旁路」；见 [02-Advanced note-XDP](../../02-Advanced-Book/notes/note-XDP与DPDK对照.md) · [06.7-BPF note-XDP](../../../06.7-bpf-observability/02-bpf-performance-tools/note-XDP与tc-BPF.md) |
