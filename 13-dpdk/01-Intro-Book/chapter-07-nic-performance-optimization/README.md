...
| 2. 轮询与混合中断 | [notes/section-2-轮询与混合中断模式.md](./notes/section-2-轮询与混合中断模式.md) |
| 3. I/O 性能深度优化 | [notes/section-3-IO性能深度优化.md](./notes/section-3-IO性能深度优化.md) |
| 4. 平台优化与配置 | [notes/section-4-平台优化与配置调优.md](./notes/section-4-平台优化与配置调优.md) |
| 5. 队列长度与阈值 | [notes/section-5-队列长度及阈值设置.md](./notes/section-5-队列长度及阈值设置.md) |
