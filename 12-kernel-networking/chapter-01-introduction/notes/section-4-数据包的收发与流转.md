...
> **HFT：** 共置机 **filter/nat 规则过多** 会增 **每包 CPU**；低延迟环境常 **精简 iptables**、**固定路由**，或用 **XDP 早 drop**（→ [06.7-BPF Ch10 XDP](../../../06.7-bpf-observability/bpf-performance-tools/chapter-10-networking/)）。
