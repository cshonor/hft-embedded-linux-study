...
**文件夹 12** · 全书 **14 章 + 附录 A–C** · [返回总清单](../READING-LIST.md#4-linux-kernel-networking--rami-rosen)

📋 **完整目录与 HFT 读/跳标注** → [OUTLINE.md](./OUTLINE.md)

> ⚠️ 本书基于 Linux 3.x（2014）。**Netfilter→nftables、无XDP、无eBPF网络、无io_uring、无page_pool。**
> 现代内核网络栈资料 → [12.5-modern-networking](../12.5-modern-networking/)
...
- 协议层 → [11-tcpip-protocols](../11-tcpip-protocols/)
- API 层 → [03.5-unix-network-api](../03.5-unix-network-api/)
- 用户态旁路 → [13-dpdk](../13-dpdk/)
