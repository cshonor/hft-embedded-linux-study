...
本模块主书，**按 [OUTLINE](./OUTLINE.md) 的 🔴 标注精读工具章节即可**；原理全貌补 [Learning eBPF](./LEARNING-EBPF-NOTES.md)。
...
3. **不教你写 eBPF 程序** — 纯工具使用；想自己写程序看 [Learning eBPF](./LEARNING-EBPF-NOTES.md)
4. **部分工具已演进** — bpftrace 语法、BCC 工具名有变动，实际使用以最新版为准

> 这些局限正是引入 [Learning eBPF](./LEARNING-EBPF-NOTES.md) 作为现代补充的原因。
...
| [Learning eBPF](./LEARNING-EBPF-NOTES.md) | 写 eBPF 程序 | libbpf/CO-RE 现代栈、验证器、程序类型 |
