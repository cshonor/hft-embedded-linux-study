...
**文件夹 16** · 全书 **16 章 + 附录 A–E** · [返回总清单](../READING-LIST.md#1-systems-performance-enterprise-and-the-cloud-2nd--brendan-gregg)

> **文件夹 16** · 性能分析方法论。  
> **执行顺序（HFT）：** 建议在 **06 TLPI + 07/01 MikanOS + 09–13 网络/DPDK** 之后、**16 HFT** 之前开读（见 [README](../README.md)）。  
> **前置：** [02-CSAPP](../02-computer-systems/) · [19-Hennessy](../19-computer-architecture/) · 最好已有 **03–06** 系统基础  
> **下一本：** [17-BPF](../17-bpf-observability/)（紧接 13）  
...
**下一本（紧接）：** [17-bpf-observability](../17-bpf-observability/) — Ch 15 预览在此展开为 bpftrace/BCC 全书。
