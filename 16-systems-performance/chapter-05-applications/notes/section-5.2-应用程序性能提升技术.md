...
- 行情：**预分配 mbuf / ring buffer**，热路径零 malloc（→ [15-DPDK 01-Intro ch02](../../../15-dpdk/01-Intro-Book/notes/chapter-02-mbuf与内存池/)）。
...
→ [19-Hennessy Ch2](../../../19-computer-architecture/) MESI · [13-DPDK CROSS-MODULE](../../README.md)
...
→ [05-linux-kernel](../../../05-linux-kernel/) 调度与绑核 · [18-HFT ch05](../../../18-hft-engineering/chapter-05-操作系统内核极致调优/)
