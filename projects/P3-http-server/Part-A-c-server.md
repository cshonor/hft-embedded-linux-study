...
| [PNP epoll 实战](../../04.5-network-sockets/07_IO_epoll.md) | epoll LT vs ET 实际代码 |
...
| epoll API | [TLPI ch63](../../03-linux-userspace-api/chapter-63-alternative-io/) · [PNP epoll](../../04.5-network-sockets/07_IO_epoll.md) |
| LT vs ET 区别 | [CSAPP 12.2](../../02-computer-systems/chapter-12-concurrent-programming/notes/section-12.2-基于I-O多路复用的并发编程.md) |
| 非阻塞 I/O | [PNP NonBlockingIO](../../04.5-network-sockets/06_NonBlockingIO.md) |
