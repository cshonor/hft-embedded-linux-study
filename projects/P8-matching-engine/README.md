...
> **做法：项目驱动，[`18`](../../18-hft-engineering/) / [`21`](../../21-rust-quant/) / [`22`](../../22-markets-microstructure/) 笔记当字典。**
...
| 瞄一眼 | 只要留下印象 |
|--------|-------------|
| [HFT ch02 撮合原理](../../18-hft-engineering/chapter-02-交易所架构与撮合原理.md) | 价格优先 + 时间优先 |
| [HFT ch03 订单簿](../../18-hft-engineering/chapter-03-订单簿深度与行情解析.md) | LOB = 买单簿 + 卖单簿 |
| [HFT ch07 无锁数据结构](../../18-hft-engineering/chapter-07-无锁数据结构与内存布局.md) | SPSC ring buffer、缓存行对齐 |
| [HFT ch08 核心引擎](../../18-hft-engineering/chapter-08-超低延迟核心引擎开发.md) | 绑核/大页/mlock |
| [HFT ch10 延迟测量](../../18-hft-engineering/chapter-10-延迟测量与基准压测.md) | p50/p99/p999 |
...
| 卡住了… | 翻这里 |
|---------|--------|
| 撮合规则 | [HFT ch02](../../18-hft-engineering/chapter-02-交易所架构与撮合原理.md) |
| 订单簿结构 | [HFT ch03](../../18-hft-engineering/chapter-03-订单簿深度与行情解析.md) |
...
| 无锁原理 | [HFT ch07](../../18-hft-engineering/chapter-07-无锁数据结构与内存布局.md) |
...
| 卡住了… | 翻这里 |
|---------|--------|
| 绑核/大页/mlock | [HFT ch05](../../18-hft-engineering/chapter-05-操作系统内核极致调优.md) |
| 延迟测量 | [HFT ch10](../../18-hft-engineering/chapter-10-延迟测量与基准压测.md) |
| 内存布局 | [HFT ch07](../../18-hft-engineering/chapter-07-无锁数据结构与内存布局.md) |
...
| HFT 调优 | [HFT ch05](../../18-hft-engineering/chapter-05-操作系统内核极致调优.md) |
...
| 模块 | 用到什么 |
|------|----------|
| [`18` hft-engineering](../../18-hft-engineering/) | LOB、撮合、无锁、绑核、HFT 工程全链 |
...
← [projects 总览](../README.md) · [21 模块](../../18-hft-engineering/) · [22 模块](../../21-rust-quant/)
