...
| 瞄一眼 | 只要留下印象 |
|--------|-------------|
| [HFT ch02 撮合原理](../../14-hft-engineering/chapter-02-exchange-architecture-matching/README.md) | 价格优先 + 时间优先 |
| [HFT ch03 订单簿](../../14-hft-engineering/chapter-03-orderbook-depth-market-data/README.md) | LOB = 买单簿 + 卖单簿 |
| [HFT ch07 无锁数据结构](../../14-hft-engineering/chapter-07-lockless-data-structures-memory-layout/README.md) | SPSC ring buffer、缓存行对齐 |
| [HFT ch08 核心引擎](../../14-hft-engineering/chapter-08-ultra-low-latency-engine-dev/README.md) | 绑核/大页/mlock |
| [HFT ch09 延迟测量](../../14-hft-engineering/chapter-09-latency-measurement-benchmarking/README.md) | p50/p99/p999 |
...
| 卡住了… | 翻这里 |
|---------|--------|
| 撮合规则 | [HFT ch02](../../14-hft-engineering/chapter-02-exchange-architecture-matching/README.md) |
| 订单簿结构 | [HFT ch03](../../14-hft-engineering/chapter-03-orderbook-depth-market-data/README.md) |
...
| 无锁原理 | [HFT ch07](../../14-hft-engineering/chapter-07-lockless-data-structures-memory-layout/README.md) |
| memory order | [C++ Concurrency ch05](../../04-cpp/M3-deep-principles/02-Cpp-Concurrency/ch05-memory-model-atomics/) |
...
| 卡住了… | 翻这里 |
|---------|--------|
| 绑核/大页/mlock | [HFT ch05](../../14-hft-engineering/chapter-05-os-kernel-tuning/README.md) |
| 延迟测量 | [HFT ch09](../../14-hft-engineering/chapter-09-latency-measurement-benchmarking/README.md) |
| 内存布局 | [HFT ch07](../../14-hft-engineering/chapter-07-lockless-data-structures-memory-layout/README.md) |
...
| HFT 调优 | [HFT ch05](../../14-hft-engineering/chapter-05-os-kernel-tuning/README.md) |
