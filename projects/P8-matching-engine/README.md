...
> **做法：项目驱动，[`21`](../../21-hft-engineering/) / [`22`](../../22-rust-quant/) / [`23`](../../23-markets-microstructure/) 笔记当字典。**
...
| 瞄一眼 | 只要留下印象 |
|--------|-------------|
| [HFT ch02 撮合原理](../../21-hft-engineering/chapter-02-交易所架构与撮合原理.md) | 价格优先 + 时间优先 |
| [HFT ch03 订单簿](../../21-hft-engineering/chapter-03-订单簿深度与行情解析.md) | LOB = 买单簿 + 卖单簿 |
| [HFT ch07 无锁数据结构](../../21-hft-engineering/chapter-07-无锁数据结构与内存布局.md) | SPSC ring buffer、缓存行对齐 |
| [HFT ch08 核心引擎](../../21-hft-engineering/chapter-08-超低延迟核心引擎开发.md) | 绑核/大页/mlock |
| [HFT ch10 延迟测量](../../21-hft-engineering/chapter-10-延迟测量与基准压测.md) | p50/p99/p999 |
| [Harris 订单类型](../../23-markets-microstructure/) | 限价单/市价单/IOC/FOK |
...
| 卡住了… | 翻这里 |
|---------|--------|
| 撮合规则 | [HFT ch02](../../21-hft-engineering/chapter-02-交易所架构与撮合原理.md) |
| 订单簿结构 | [HFT ch03](../../21-hft-engineering/chapter-03-订单簿深度与行情解析.md) |
| 订单类型 | [Harris](../../23-markets-microstructure/) |
...
| 卡住了… | 翻这里 |
|---------|--------|
| 订单类型定义 | [Harris](../../23-markets-microstructure/) |
...
| 无锁原理 | [HFT ch07](../../21-hft-engineering/chapter-07-无锁数据结构与内存布局.md) |
| memory order | [C++ Concurrency ch05](../../06-cpp/M2-deep-principles/02-Cpp-Concurrency/ch05-memory-model-atomics/) |
...
| 卡住了… | 翻这里 |
|---------|--------|
| 绑核/大页/mlock | [HFT ch05](../../21-hft-engineering/chapter-05-操作系统内核极致调优.md) |
| 延迟测量 | [HFT ch10](../../21-hft-engineering/chapter-10-延迟测量与基准压测.md) |
| 内存布局 | [HFT ch07](../../21-hft-engineering/chapter-07-无锁数据结构与内存布局.md) |
...
| HFT 调优 | [HFT ch05](../../21-hft-engineering/chapter-05-操作系统内核极致调优.md) |
...
| 卡住了… | 翻这里 |
|---------|--------|
| Rust 基础 | [Rust ch02](../../22-rust-quant/chapter-02-Rust基础与交易工程搭建.md) |
| Rust 交易引擎 | [Rust ch07](../../22-rust-quant/chapter-07-实盘交易引擎开发.md) |
| unsafe 边界 | [Rust ch02](../../22-rust-quant/chapter-02-Rust基础与交易工程搭建.md) |
...
← [projects 总览](../README.md) · [21 模块](../../21-hft-engineering/) · [22 模块](../../22-rust-quant/)
