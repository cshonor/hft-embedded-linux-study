...
| | |
|---|---|
| **本章干什么** | **eye / blocks** 等动画示例；更复杂的 **图形 + 定时事件**。 |
| **全书作用** | **事件驱动 GUI（下）** — 巩固用户态图形；为多终端、多应用并发打体验基础。 |
| **← 前置** | [Ch22 图形事件（1）](../chapter-22-graphics-events1/) |
| **→ 后续** | [Ch24 多终端](../chapter-24-multi-terminal/) — 多进程 + 多页表 |
