...
| | |
|---|---|
| **本章干什么** | **syscall 门** · **Ring 0/3** · 用户态 **异常处理**；Newlib 通过 syscall 调内核。 |
| **全书作用** | **特权级边界**（🔴）— 从「内核里跑 cat」到「真正的用户态进程」；TLPI / LKD syscall 章的对照实验。 |
| **← 前置** | [Ch19 分页](../chapter-19-paging/) |
| **→ 后续** | [Ch21 窗口应用](../chapter-21-window-apps/) — 用户态 GUI 程序 |
