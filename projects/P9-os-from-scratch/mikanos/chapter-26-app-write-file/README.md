...
| | |
|---|---|
| **本章干什么** | **Write** · **stdio** · **cp** · **stdin 回显**；FAT **写扩展**。 |
| **全书作用** | **用户态文件写**（🟡）— 完整「读+写+复制」；Ch28 重定向、Ch29 管道需要可写 fd。 |
| **← 前置** | [Ch25 读文件](../chapter-25-app-read-file/) |
| **→ 后续** | [Ch27 应用内存管理](../chapter-27-app-memory/) |
