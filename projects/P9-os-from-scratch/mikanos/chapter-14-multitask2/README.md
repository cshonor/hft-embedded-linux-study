...
| | |
|---|---|
| **本章干什么** | **定时器抢占** · **任务优先级 Level** · 解决鼠标卡顿；完善 **TaskManager**。 |
| **全书作用** | **内核骨架 · 调度**（🔴）— 接近「像 OS 一样响应」；Ch15+ 终端/命令在抢占式调度上运行。 |
| **← 前置** | [Ch13 协作多任务](../chapter-13-multitask1/) |
| **→ 后续** | [Ch15 终端](../chapter-15-terminal/) — GUI 里的终端窗口 |
...
| 与 Linux / CSAPP 对照？ | runqueue / **SCHED** 雏形 — [ULK 调度](../../../../08-linux-kernel-deep/chapter-07-process-scheduling.md) |
