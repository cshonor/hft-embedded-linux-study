...
**对照 thirty-days-os：** Day 5–16（IDT/PIC/多任务）— 同一概念，不同架构（APIC、64 bit）。
...
**交叉：** [02-CSAPP](../../../02-computer-systems/) Ch 9 · [05-linux-kernel](../../../05-linux-kernel/) Ch 5/10 · [19-linux-kernel-deep](../../../19-linux-kernel-deep/) Ch 2/9/10。
...
| 坑 | 说明 |
|----|------|
| 跳过 thirty-days-os-essentials 直接 MikanOS | 可以，但 **实模式→保护模式** 体感会缺一块 |
