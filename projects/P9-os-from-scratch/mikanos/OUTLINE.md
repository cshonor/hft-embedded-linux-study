...
> **笔记目录：** 各章独立目录 `chapter-XX-slug/`（导读 `README.md` + `notes/section-*.md`）— 对齐 [02 30 天 OS 精华](../thirty-days-os-essentials/) 的 `day-XX-slug/` 框架
...
- 与 [01 Day 1](../thirty-days-os-essentials/day-01-boot-asm/) 对照：BIOS `0x7C00` vs UEFI **`/EFI/BOOT/BOOTX64.EFI`**
...
- **协作/抢占多任务** — 对照 [01 Day 15–16](../thirty-days-os-essentials/day-15-multitask1/)
