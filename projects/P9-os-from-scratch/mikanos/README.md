...
**P9-os-from-scratch** 子模块 · [返回 P9 总览](../README.md)

> **父项目：** [P9-os-from-scratch](../README.md)  
> **原著：** 内田公太（uchan）· **《从零自制操作系统》**（日版 *ゼロからの OS 自作入門*）  
> **本仓库：** HFT 学习链裁剪笔记 + 实验记录（非全书翻译）  
> **HFT 路线定位：** 🟡 **Phase 6 拓展** — 内核学完后再来翻，不必先做完 [02 30 天精华](../thirty-days-os-essentials/)  
...
> **定位：** **现代 64 位 UEFI OS** — **HFT / 服务器底层主线**；与 [02 30 天](../thirty-days-os-essentials/)（BIOS 软盘启蒙）**互补但不前置依赖**。
...
**标签：** 🟡 Phase 6 拓展 · 内核学完后再翻

**动手前必读：** [LEARNING_PLAN.md](./LEARNING_PLAN.md) · [P9 README](../README.md)

---

## 与 thirty-days-os-essentials 的分工
...
与 [02 30 天 OS 精华](../thirty-days-os-essentials/) · [16-Systems-Performance](../../../14-systems-performance/) 一致：每章独立目录，导读 + 分段笔记。
