...
| | |
|---|---|
| **本章干什么** | **stars** · **ReadEvent** · 用户态 **事件循环** 与基础绘图 syscall。 |
| **全书作用** | **事件驱动 GUI（上）** — 从静态窗口到「等事件再画」；游戏/桌面应用编程模型入门。 |
| **← 前置** | [Ch21 窗口应用](../chapter-21-window-apps/) |
| **→ 后续** | [Ch23 图形和事件（2）](../chapter-23-graphics-events2/) |
