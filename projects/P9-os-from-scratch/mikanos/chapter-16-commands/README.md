...
| | |
|---|---|
| **本章干什么** | **命令解析** · **history** · 方向键；实现 **ls / cat / …** 等内置命令框架。 |
| **全书作用** | **用户界面层（内核态 shell）** — 把多任务 + 终端变成「能敲命令的 OS」；Ch17 文件系统命令的前置。 |
| **← 前置** | [Ch15 Terminal](../chapter-15-terminal/) |
| **→ 后续** | [Ch17 文件系统](../chapter-17-filesystem/) — 持久化存储与 FAT |
