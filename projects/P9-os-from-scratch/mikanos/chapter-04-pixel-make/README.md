...
| | |
|---|---|
| **本章干什么** | 在内核中 **直接写 Frame Buffer 像素**；完善 **make** 构建；理解 **ELF** 与加载器改进。 |
| **全书作用** | **图形底座** — 从「能显示」到「能绘图」；为 Ch5 文本、Ch9–10 窗口合成提供像素级 API 直觉。 |
| **← 前置** | [Ch3 GOP / kernel.elf](../chapter-03-bootloader-display/) — 已有帧缓冲与 KernelMain |
| **→ 后续** | [Ch5 Console 文本](../chapter-05-console-text/) — 在像素之上叠加字符输出 |
