...
| 2. EDK II 与 MikanLoader | [notes/section-2-EDK-II与MikanLoader.md](./notes/section-2-EDK-II与MikanLoader.md)（**索引**） · [Ch1 §7](../chapter-01-hello-world/notes/section-7-Ch1裸C与Ch2-EDKII全链路.md) · **[code/MikanLoaderPkg/](./code/MikanLoaderPkg/)** |
...
| 与 Linux / CSAPP 对照？ | 类似 `/proc/iomem` / 固件 e820 — 对照 [CSAPP Ch9](../../../../02-computer-systems/chapter-09-virtual-memory/) 虚拟地址 **之前** 的物理布局 |
