...
| # | 笔记 | 带走什么 |
|---|------|----------|
| **3.1** | [kernel.elf · ELF 是什么 · **误区纠正**](./section-3-1-kernel.elf基础定义与核心作用.md) | ELF **通用格式** · vs `.efi` · 三者关系 |
...
| **3.6** | [MikanLoader **完整六步**](./section-3-6-MikanLoader加载流程.md) | 读 ELF → 搬段 → BSS → ExitBS → 跳 `e_entry` |
