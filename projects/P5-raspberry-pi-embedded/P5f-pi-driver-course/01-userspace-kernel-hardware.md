...
- [ ] 能区分：DT 不是驱动；`.ko` / built-in 都是内核代码 — [Primer 8.2](../../../09-device-drivers-dt/01-hello-module/1.1-why-drivers-in-kernel.md)  
- [ ] 能复述：驱动管初始化 + 读写 + **中断** + 释放 — [Primer 8.3](../../../09-device-drivers-dt/01-hello-module/1.3-driver-lifecycle-and-irq.md)
