...
| 瞄一眼 | 只要留下印象 |
|--------|-------------|
| [1.4.3 container_of 宏](../../01-c-language/05-embedded-kernel-practice/01-ch1-gnu-c-basics/1.4-typeof-container-of/1.4.3-Linux内核中的container_of宏.md) | 从成员指针反推宿主结构体指针 |
| [1.3 语句表达式](../../01-c-language/05-embedded-kernel-practice/01-ch1-gnu-c-basics/1.3-statement-expr/1.3.2-语句表达式.md) | `({ ... })` 让宏里能写多行语句 |
| [2.2.1 aligned](../../01-c-language/05-embedded-kernel-practice/02-ch2-gnu-c-advanced/2.2-aligned/2.2.1-地址对齐-aligned.md) | `__attribute__((aligned(64)))` 控制对齐 |
| [2.4 weak 符号](../../01-c-language/05-embedded-kernel-practice/02-ch2-gnu-c-advanced/2.4-weak/2.4-属性声明-weak.md) | 弱符号 = 可被覆盖的默认实现 |
...
| 卡住了… | 翻这里 |
|---------|--------|
| offsetof 怎么算的 | [1.4.4 container_of 实现分析](../../01-c-language/05-embedded-kernel-practice/01-ch1-gnu-c-basics/1.4-typeof-container-of/1.4.4-container_of宏实现分析.md) |
| typeof 语法 | [1.4.1 typeof 关键字](../../01-c-language/05-embedded-kernel-practice/01-ch1-gnu-c-basics/1.4-typeof-container-of/1.4.1-typeof关键字.md) |
| `({ })` 语句表达式 | [1.3.2 语句表达式](../../01-c-language/05-embedded-kernel-practice/01-ch1-gnu-c-basics/1.3-statement-expr/1.3.2-语句表达式.md) |
...
| 卡住了… | 翻这里 |
|---------|--------|
| aligned 属性 | [2.2.1 地址对齐 aligned](../../01-c-language/05-embedded-kernel-practice/02-ch2-gnu-c-advanced/2.2-aligned/2.2.1-地址对齐-aligned.md) |
| __attribute__ 基础 | [2.1.1 __attribute__](../../01-c-language/05-embedded-kernel-practice/02-ch2-gnu-c-advanced/2.1-section/2.1.1-GNU-C编译器扩展关键字-__attribute__.md) |
...
| 卡住了… | 翻这里 |
|---------|--------|
| __builtin_ 内建函数 | [2.5.2 常用内建函数](../../01-c-language/05-embedded-kernel-practice/02-ch2-gnu-c-advanced/2.5-builtin/2.5.2-常用的内建函数.md) |
| __builtin_constant_p | [2.5.4 __builtin_constant_p](../../01-c-language/05-embedded-kernel-practice/02-ch2-gnu-c-advanced/2.5-builtin/2.5.4-内建函数-__builtin_constant_p-n.md) |
| likely/unlikely | [2.5.6 likely 和 unlikely](../../01-c-language/05-embedded-kernel-practice/02-ch2-gnu-c-advanced/2.5-builtin/2.5.6-Linux内核中的likely和unlikely.md) |
...
| weak 符号 | [2.4 weak](../../01-c-language/05-embedded-kernel-practice/02-ch2-gnu-c-advanced/2.4-weak/2.4-属性声明-weak.md) |
...
| 卡住了… | 翻这里 |
|---------|--------|
| packed/aligned | [2.2.4 packed](../../01-c-language/05-embedded-kernel-practice/02-ch2-gnu-c-advanced/2.2-aligned/2.2.4-属性声明-packed.md) |
| 内核中的 aligned+packed | [2.2.5 内核中的声明](../../01-c-language/05-embedded-kernel-practice/02-ch2-gnu-c-advanced/2.2-aligned/2.2.5-内核中的aligned-packed声明.md) |
| section 属性 | [2.1.2 section](../../01-c-language/05-embedded-kernel-practice/02-ch2-gnu-c-advanced/2.1-section/2.1.2-属性声明-section.md) |
