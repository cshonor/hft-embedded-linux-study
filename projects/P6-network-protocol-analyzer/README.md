...
> **做法：项目驱动，[`12`](../../04.5-network-sockets/) / [`13`](../../12-tcpip-protocols/) / [`14`](../../13-kernel-networking/) / [`17`](../../16-bpf-observability/) 笔记当字典。**
...
| 模块 | 用到什么 |
|------|----------|
| [`12` network-sockets](../../04.5-network-sockets/) | UNP：raw socket、socket 选项 |
...
← [projects 总览](../README.md) · [15 模块](../../04.5-network-sockets/) · [17 模块](../../13-kernel-networking/)
