...
→ 无锁环、per-core 队列 — [16 HFT ch07](../../../17-hft-engineering/)
...
→ [CSAPP Ch6](../../../02-computer-systems/chapter-06-memory-hierarchy/) · [chapter-02-Cache与内存](../chapter-02-cache-and-memory/)
...
与 [03 SysPerf](../../../15-systems-performance/) 方法论一致 — **用 perf/BPF 验证** 而非凭直觉。
