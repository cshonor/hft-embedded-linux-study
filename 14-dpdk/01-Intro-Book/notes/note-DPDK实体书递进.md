...
> 本仓库 `08` 文件夹主线仍是 [DPDK 官方文档](../../README.md)；两本书帮你**建立认知 → 挖深度**，与 [01-Intro-Book](../) chapter-01–05 对照阅读。
...
| SPDK、用户态 NVMe、iSCSI | [chapter-14-dpdk-storage-optimization](./chapter-14-dpdk-storage-optimization/)（实体书 Ch15 · **应用篇压轴**） |
...
- 解释 **DPDK 为何能把延迟压到微秒级**（旁路 + 轮询 + 预分配 + 绑核，与 `16` SysPerf 度量对齐）
...
| **XDP / tc-BPF** | 内核最早点丢/改包 | 对比 DPDK 的「半旁路」；见 [02-Advanced note-XDP](../../02-Advanced-Book/notes/note-XDP与DPDK对照.md) · [17-BPF note-XDP](../../../16-bpf-observability/note-XDP与tc-BPF.md) |
...
- 回到 [17-hft-engineering](../../../17-hft-engineering/) ch06/ch08 — 把技术落到量化系统
- 用 [17-BPF](../../../16-bpf-observability/) + `16` SysPerf Ch10 在生产上**验证**旁路收益
