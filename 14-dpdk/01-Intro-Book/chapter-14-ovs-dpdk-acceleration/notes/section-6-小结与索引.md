...
Ch14 OVS-DPDK（虚拟交换机数据面）
    ↓
Ch15 SPDK 网络存储（应用篇压轴）← 见 [chapter-15](../chapter-14-dpdk-storage-optimization/)
    ↓
02-Advanced / HFT 落地
```
...
| Ch14 主题 | 继续读 |
|----------|--------|
| SPDK 存储 | [chapter-14-dpdk-storage-optimization](../chapter-14-dpdk-storage-optimization/) 🟡 |
