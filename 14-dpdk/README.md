...
| 序号 | 文件夹 | 层级 | 回答的问题 |
|------|--------|------|-----------|
| 07 | [TCP/IP Illustrated Vol.1](../12-tcpip-protocols/) | 协议 | 线上包长什么样？ |
| 08 | [UNP Vol.1](../03.5-unix-network-api/) | 系统调用 / Socket API | 用户态怎么调内核网络栈？ |
| 09 | [Linux Kernel Networking](../13-kernel-networking/) | 内核实现 | 内核怎么收发包？ |
...
- 内核栈对照 → [13-kernel-networking](../13-kernel-networking/)
...
- 缓存 / 内存 → [02-computer-systems Ch6](../02-computer-systems/chapter-06-memory-hierarchy/)、[18-computer-architecture](../18-computer-architecture/)
- 生产观测 → [16-bpf-observability](../16-bpf-observability/)
- 工程落地 → [17-hft-engineering](../17-hft-engineering/)
