...
→ [14-Rosen](../../../12-kernel-networking/) · [17-BPF note-XDP](../../../15-bpf-observability/bpf-performance-tools/note-XDP与tc-BPF.md)
...
→ [09 Rosen NAPI/softirq](../../../12-kernel-networking/) · [README 跨模块对照](../../README.md)
...
极致延迟：12-DPDK 01-Intro（组播） / 02-Advanced XDP·RDMA
```

→ [15-DPDK](../../../13-dpdk/) · [15-Advanced XDP note](../../../13-dpdk/02-Advanced-Book/notes/note-XDP与DPDK对照.md)
