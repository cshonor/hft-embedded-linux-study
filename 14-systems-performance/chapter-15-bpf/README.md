...
> **HFT：** 生产裸机 **bpftrace/BCC 与 perf 并列标配** — off-CPU、run queue、重传、direct reclaim；深度专书 → [15-bpf-observability](../../15-bpf-observability/)。
...
SysPerf Ch 1–14  →  Ch 15 BPF 总入口
  → 15-bpf-observability 全书（紧接 14 SysPerf）
...
- BPF 专书：[15-bpf-observability](../../15-bpf-observability/)
- XDP：[17-BPF note-XDP](../../15-bpf-observability/bpf-performance-tools/note-XDP与tc-BPF.md) · [15-DPDK 02-Advanced](../../13-dpdk/02-Advanced-Book/notes/note-XDP与DPDK对照.md)
