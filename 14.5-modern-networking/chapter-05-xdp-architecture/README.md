...
- `14.5-modern-networking/chapter-06-af-xdp/`：AF_XDP 将包重定向到用户态
- `14.5-modern-networking/chapter-07-xdp-redirect-dpdk/`：XDP redirect 机制与 DPDK 对比
- `15-dpdk/`：DPDK 完全 bypass 内核，XDP 是内核态替代方案
