...
- `14.5-modern-networking/chapter-04-page-pool/`：UMEM 基于 page_pool
- `14.5-modern-networking/chapter-05-xdp-architecture/`：XDP 架构，AF_XDP 是 XDP redirect 目标
- `15-dpdk/`：DPDK 完全 bypass，AF_XDP 是内核态折中
