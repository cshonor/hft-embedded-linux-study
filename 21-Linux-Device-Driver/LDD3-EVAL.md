...
> **内核：** 约 **2.6.10**（2005）  
> **大纲：** [linux-device-drivers-3rd/OUTLINE.md](./linux-device-drivers-3rd/OUTLINE.md)（18 章）  
> 四书代号 **C**：[FOUR-BOOKS-OVERLAP](../20-UBoot-Kernel-Build/FOUR-BOOKS-OVERLAP.md)
...
| 书 | 角色 |
|----|------|
| [Embedded Linux Primer](../20-UBoot-Kernel-Build/embedded-linux-primer/) | 系统全景：Boot / rootfs / 交叉环境 |
| [Madieu](./linux-device-drivers-development/) | ARM · DTS · I2C/SPI/GPIO **实操**（树莓派主书） |
