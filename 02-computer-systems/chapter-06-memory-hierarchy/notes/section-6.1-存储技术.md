...
> ↔ [Hennessy §2.2 存储器技术](../../../15-computer-architecture/chapter-02-memory-hierarchy-design/notes/section-2.2-存储器技术与优化.md)
...
- 共置机器 **足够 DRAM** 装 working set；swap 禁用（→ [14-HFT](../../../14-hft-engineering/)）
