...
3. **CPI / IPC** — `perf` 里 IPC 低，往 cache miss、分支、后端瓶颈想（→ [16-Systems-Performance Ch 6](../../16-systems-performance/chapter-06-cpus/)）
...
- 真实微架构：[19-Hennessy](../../19-computer-architecture/)
