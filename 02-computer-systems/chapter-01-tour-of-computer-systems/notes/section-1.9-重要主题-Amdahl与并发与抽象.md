...
**HFT：** 端到端延迟 = 收包 + 解码 + 策略 + 发单 + **排队/内核/网卡**。用 [18-HFT ch10](../../../18-hft-engineering/chapter-10-延迟测量与基准压测/) 或 span 分解找 **最大 p**，再动刀。

→ 方法论：[16-Systems-Performance Ch 2 延迟分解](../../../16-systems-performance/chapter-02-methodologies/)
