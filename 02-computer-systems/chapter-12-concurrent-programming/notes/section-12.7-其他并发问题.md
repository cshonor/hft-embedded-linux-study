...
> ↔ [Hennessy §5.6 一致性模型](../../../03-computer-architecture/chapter-05-thread-level-parallelism/notes/section-5.6-内存一致性模型.md)
...
→ C++ `std::atomic` / `memory_order` · [12-HFT](../../../21-hft-engineering/)
