...
> **书目：** 陈硕 *Linux 多线程服务端编程*、Stevens *Unix Network Programming* Vol.1（索引在子目录）。
...
**上一章：** [14 运动控制](../14-motion-control/)（嵌入式支线）或从 [06 C++](../06-cpp/) 进网络  
**下一章：** [16 TCP/IP 协议](../16-tcpip-protocols/)
