...
> **定位：** [06.7-bpf-observability/](../) 模块的**现代原理书** — 补 [BPF Performance Tools](../bpf-performance-tools/BPF-PERFORMANCE-TOOLS-EVAL.md) 缺的 libbpf/CO-RE/验证器/程序类型  
...
读法：**先本书建原理框架 → 再 [BPF Performance Tools](../bpf-performance-tools/BPF-PERFORMANCE-TOOLS-EVAL.md) 练工具**。
...
[BPF Performance Tools](../bpf-performance-tools/BPF-PERFORMANCE-TOOLS-EVAL.md)（2019）停在 BCC Python 脚本范式，缺：
...
**优先级：** 在 [BPF Performance Tools](../bpf-performance-tools/BPF-PERFORMANCE-TOOLS-EVAL.md) 之后入；如果只想买一本 eBPF 书且要从零学，**先买这本**。
