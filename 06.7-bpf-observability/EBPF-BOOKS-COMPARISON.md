...
> 本模块主书为 **BPF Performance Tools**（Brendan Gregg，详见 [OUTLINE](./02-bpf-performance-tools/OUTLINE.md)）。
...
- 18 章 + 附录 A–E 的工具谱系，HFT 读/跳标注见 [OUTLINE](./02-bpf-performance-tools/OUTLINE.md)
...
### ③ BPF Performance Tools（本模块，详见 [OUTLINE](./02-bpf-performance-tools/OUTLINE.md)）
