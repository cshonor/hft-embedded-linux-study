...
11. Native 与 Generic 模式的本质区别是什么？为什么 Generic 只能验证功能、不能测性能？
12. 按顺序描述一个包从"网卡收到"到"XDP 程序执行"的完整链路（含 DMA 与 RX 环描述符；XDP 程序本身会配置 DMA 吗？）。
13. XDP 程序与 tracepoint/kprobe 程序在挂点语义上的本质区别是什么？
