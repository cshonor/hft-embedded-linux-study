...
| 原书小节 | 笔记 |
|---|---|
| §5.1–5.2 | [5.1 BCC之弊与CO-RE要素](./notes/5.1_BCC之弊与CO-RE要素.md) |
| §5.3–5.4 | [5.2 BTF与vmlinux](./notes/5.2_BTF与vmlinux.md) |
| §5.5–5.6 | [5.3 内核侧与用户侧实现](./notes/5.3_内核侧与用户侧实现.md) |
| §5.7–5.9 | [5.4 坑点HFT关联与自测](./notes/5.4_坑点HFT关联与自测.md) |
