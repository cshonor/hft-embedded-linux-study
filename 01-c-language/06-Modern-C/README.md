...
第 6 本书 · **标准增量 + 现代写法**。五本书（C89 + GNU C）之后，把 C99–C23 的增量补齐，
并以标准委员会视角重讲指针、内存模型、原子与并发——**进 DPDK 前的理论收官**。

为什么不换掉五本书：内核主体仍是 GNU C89/C99，五本书教的是标准无关的思维；
...
**一句话路线：** 五本书 → 00 差异速查 → Ch12/13/16 → （开 DPDK 前）Ch20/21 → 其余当字典。
...
- [00-C89-to-C23-diff-and-reading-map](./00-C89-to-C23-diff-and-reading-map.md) — C89→C23 差异速查 + 五本书"过时清单"（先读这个再开书）
