...
- [3.6 链接属性](./3.6-linkage/3.6-链接属性.md)
  - [3.6.1 外部链接](./3.6-linkage/3.6.1-外部链接.md)
  - [3.6.2 内部链接](./3.6-linkage/3.6.2-内部链接.md)
  - [3.6.3 无链接](./3.6-linkage/3.6.3-无链接.md)
- [3.7 存储类型](./3.7-storage/3.7-存储类型.md)
  - [3.7.1 自动存储期](./3.7-storage/3.7.1-自动存储期.md)
  - [3.7.2 静态存储期](./3.7-storage/3.7.2-静态存储期.md)
  - [3.7.3 线程存储期](./3.7-storage/3.7.3-线程存储期.md)
  - [3.7.4 动态内存](./3.7-storage/3.7.4-动态内存.md)
