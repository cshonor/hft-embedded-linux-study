...
REPO_GH = "https://github.com/cshonor/hft-embedded-linux-study/blob/main/01-c-language/01-basics-syntax-and-types"
...
{quiz_html}
    ...
    <footer class="footer">
      <div class="content">
        <p>Generated from <code class="c">01-c-language/01-basics-syntax-and-types/{chdir}</code> · hft-embedded-linux-study</p>
      </div>
    </footer>
  </main>
</div>
