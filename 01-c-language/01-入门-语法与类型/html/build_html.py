...
REPO_GH = "https://github.com/cshonor/hft-embedded-linux-study/blob/main/01-c-language/01-入门-语法与类型"
...
{quiz_html}
    ...
    <footer class="footer">
      <div class="content">
        <p>Generated from <code class="c">01-c-language/01-入门-语法与类型/{chdir}</code> · hft-embedded-linux-study</p>
      </div>
    </footer>
  </main>
</div>
