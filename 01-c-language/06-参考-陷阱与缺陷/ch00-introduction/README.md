...
4. **实现定义/未定义**：同一源码不同编译器/优化等级结果不同（与 [Expert C ch08](../../03-提高-声明与链接/ch08-halloween-vs-christmas/) 序列点问题呼应）
...
| **配套** | [01-入门-语法与类型](../../01-入门-语法与类型/) | 语法基础 |
| **深化** | [03-提高-声明与链接](../../03-提高-声明与链接/) | 链接、指针、表达式 UB |
