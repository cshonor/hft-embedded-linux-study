...
| **[01-basics-syntax-and-types](../../01-basics-syntax-and-types/)** | 变量、函数、作用域基础 |
...
```bash
cd 00-Linux-Kernel-DPDK-Network-C/03-expert-declarations-and-linking/ch06-runtime-data-structures/demo
...
| 关联 | **[Embedded C](../../05-embedded-kernel-practice/)** 启动代码、链接脚本、裸机栈 |
