...
```bash
cd 00-Linux-Kernel-DPDK-Network-C/03-expert-declarations-and-linking/ch07-adventures-in-memory/demo
...
| 关联 | **[Embedded C](../../05-embedded-kernel-practice/)** 裸机对齐、链接脚本 |
