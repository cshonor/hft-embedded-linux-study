...
| **[01-basics-syntax-and-types](../../01-basics-syntax-and-types/)** | 基本 C 语法；本章不教语法，教 **陷阱** |
...
```bash
cd 00-Linux-Kernel-DPDK-Network-C/03-expert-declarations-and-linking/ch02-its-not-a-bug-its-a-language-feature/demo
...
| 关联 | **[Embedded C](../../05-embedded-kernel-practice/)** ch04 链接、ch06 GNU 扩展、ch07 指针 |
