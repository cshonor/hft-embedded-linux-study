...
| **[01-basics-syntax-and-types](../../01-basics-syntax-and-types/)** | 数组、指针、字符串基础 |
...
```bash
cd 00-Linux-Kernel-DPDK-Network-C/03-expert-declarations-and-linking/ch04-arrays-are-not-pointers/demo
...
| 关联 | **[Embedded C ch07](../../05-embedded-kernel-practice/05-ch5-portable-modular/7-data-and-pointers/)** 数据存储、数组名、指针（**7.8**, **7.9**） |
