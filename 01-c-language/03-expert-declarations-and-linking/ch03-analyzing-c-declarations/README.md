...
| **[01-basics-syntax-and-types](../../01-basics-syntax-and-types/)** | 基本声明、指针、数组语法 |
...
```bash
cd 00-Linux-Kernel-DPDK-Network-C/03-expert-declarations-and-linking/ch03-analyzing-c-declarations/demo
...
| 关联 | **[Embedded C ch07](../../05-embedded-kernel-practice/05-ch5-portable-modular/7-data-and-pointers/)** 指针、存储、MMIO |
