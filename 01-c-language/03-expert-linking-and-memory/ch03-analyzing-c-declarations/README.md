...
```bash
cd 00-Linux-Kernel-DPDK-Network-C/03-expert-linking-and-memory/ch03-analyzing-c-declarations/demo
...
| 关联 | **[Embedded C ch07](../../05-embedded-kernel-practice/05-ch5-portable-modular/5.01-data-and-pointers/)** 指针、存储、MMIO |
