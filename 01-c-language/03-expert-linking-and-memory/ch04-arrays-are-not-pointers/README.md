...
```bash
cd 00-Linux-Kernel-DPDK-Network-C/03-expert-linking-and-memory/ch04-arrays-are-not-pointers/demo
...
| 关联 | **[Embedded C ch07](../../05-embedded-kernel-practice/05-ch5-portable-modular/5.01-data-and-pointers/)** 数据存储、数组名、指针（**7.8**, **7.9**） |
