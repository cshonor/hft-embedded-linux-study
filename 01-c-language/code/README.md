...
| 内容 | 正确位置 |
|------|----------|
| sizeof / ABI / endian / padding | [02-computer-systems/code/](.) |
...
| K&R / Pointers on C **笔记** | 本模块 [01-basics-syntax-and-types](../01-basics-syntax-and-types/) · [02-advanced-pointers-and-memory](../02-advanced-pointers-and-memory/) |

**02 模块职责：** 读序 + OUTLINE + 外部 C 五书索引 — **不把 CSAPP 笔记/实验再复制一份**。

← [02 导读](./README.md) · [01 CSAPP code](.)
