...
| 本链阶段 | 目录 | 书目 |
|----------|------|------|
| 🔴 02 必过 | [01-入门-语法与类型](./01-入门-语法与类型/) | K&R |
| 🔴 02 必过 | [02-进阶-指针与内存](./02-进阶-指针与内存/) | *C 和指针* |
| 🟡 **04 LKD 前** | [03-提高-声明与链接](./03-提高-声明与链接/) | *C 专家编程*（只读 ch05–ch07） |
| 🔴 **04 LKD 前** | [05-实战-嵌入式与内核](./05-实战-嵌入式与内核/) | 《嵌入式 C 自我修养》 |
| 🟡 工具书 | [06-参考-陷阱与缺陷](./06-参考-陷阱与缺陷/) | *C 陷阱与缺陷*（遇坑再查） |
| 🔴 **13 DPDK 前** | [04-规范-现代C标准](./04-规范-现代C标准/) | *Modern C* 3rd（挑读 Ch12/13/16，DPDK 前 Ch20/21） |
