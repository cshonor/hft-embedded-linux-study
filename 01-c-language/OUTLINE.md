...
| 本链阶段 | 目录 | 书目 |
|----------|------|------|
| 🔴 02 必过 | [01-basics-syntax-and-types](./01-basics-syntax-and-types/) | K&R |
| 🔴 02 必过 | [02-advanced-pointers-and-memory](./02-advanced-pointers-and-memory/) | *C 和指针* |
| 🟡 **04 LKD 前** | [03-expert-declarations-and-linking](./03-expert-declarations-and-linking/) | *C 专家编程*（只读 ch05–ch07） |
| 🔴 **04 LKD 前** | [05-embedded-kernel-practice](./05-embedded-kernel-practice/) | 《嵌入式 C 自我修养》 |
| 🟡 工具书 | [06-reference-pitfalls](./06-reference-pitfalls/) | *C 陷阱与缺陷*（遇坑再查） |
| 🔴 **13 DPDK 前** | [04-modern-c-standards](./04-modern-c-standards/) | *Modern C* 3rd（挑读 Ch12/13/16，DPDK 前 Ch20/21） |
