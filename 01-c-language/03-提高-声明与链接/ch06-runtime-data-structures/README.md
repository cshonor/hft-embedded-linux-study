...
| **[01-入门-语法与类型](../../01-入门-语法与类型/)** | 变量、函数、作用域基础 |
...
```bash
cd 00-Linux-Kernel-DPDK-Network-C/03-提高-声明与链接/ch06-runtime-data-structures/demo
...
| 关联 | **[Embedded C](../../05-实战-嵌入式与内核/)** 启动代码、链接脚本、裸机栈 |
