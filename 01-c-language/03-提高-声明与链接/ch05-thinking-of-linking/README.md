...
| **[01-入门-语法与类型](../../01-入门-语法与类型/)** | 函数、作用域、多文件编译基础 |
...
```bash
cd 00-Linux-Kernel-DPDK-Network-C/03-提高-声明与链接/ch05-thinking-of-linking/demo
...
| 关联 | **[Embedded C](../../05-实战-嵌入式与内核/)** 启动代码、链接脚本、裸机 |
