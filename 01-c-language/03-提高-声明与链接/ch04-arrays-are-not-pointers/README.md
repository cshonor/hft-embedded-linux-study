...
| **[01-入门-语法与类型](../../01-入门-语法与类型/)** | 数组、指针、字符串基础 |
...
```bash
cd 00-Linux-Kernel-DPDK-Network-C/03-提高-声明与链接/ch04-arrays-are-not-pointers/demo
...
| 关联 | **[Embedded C ch07](../../05-实战-嵌入式与内核/05-ch5-portable-modular/7-data-and-pointers/)** 数据存储、数组名、指针（**7.8**, **7.9**） |
