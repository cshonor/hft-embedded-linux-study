...
| **[01-入门-语法与类型](../../01-入门-语法与类型/)** | 基本 C 语法；本章不教语法，教 **陷阱** |
...
```bash
cd 00-Linux-Kernel-DPDK-Network-C/03-提高-声明与链接/ch02-its-not-a-bug-its-a-language-feature/demo
...
| 关联 | **[Embedded C](../../05-实战-嵌入式与内核/)** ch04 链接、ch06 GNU 扩展、ch07 指针 |
