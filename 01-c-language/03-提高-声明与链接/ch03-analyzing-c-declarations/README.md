...
| **[01-入门-语法与类型](../../01-入门-语法与类型/)** | 基本声明、指针、数组语法 |
...
```bash
cd 00-Linux-Kernel-DPDK-Network-C/03-提高-声明与链接/ch03-analyzing-c-declarations/demo
...
| 关联 | **[Embedded C ch07](../../05-实战-嵌入式与内核/05-ch5-portable-modular/7-data-and-pointers/)** 指针、存储、MMIO |
