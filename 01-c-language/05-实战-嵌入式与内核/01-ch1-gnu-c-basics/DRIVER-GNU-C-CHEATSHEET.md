...
| 扩展 | 典型写法 | 驱动里干什么 | 深挖 |
|------|----------|--------------|------|
| **指定初始化** | `{ .compatible = "a,b" }, { .probe = fn }` | `of_match_table`、`file_operations`、`platform_driver` | [6.2](./6.2-designated-init/) · [struct 驱动向](../../01-入门-语法与类型/ch06-structures/6.0-struct-for-drivers.md) |
