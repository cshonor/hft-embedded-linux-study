...
> 恢复命令：`git log --diff-filter=D --name-only -- 01-c-language/05-实战-嵌入式与内核/`。
...
| **B** | ch07 | [数据存储与指针](./05-ch5-portable-modular/7-data-and-pointers/) | 43 | 2545 | 37% | **只挑与嵌入式强相关的节** | 指针基础与 [Pointers on C](../02-进阶-指针与内存/) 重叠 | 精挑 7.2 对齐 / 7.3 可移植性 / 7.4 size_t / 7.13 void；其余维持 |
...
| 10 | **CH2** | [6.8 format](./02-ch2-gnu-c-advanced/6.8-format/) | 8 KB/4 篇 | 已由 [Pointers on C 7.6.2](../02-进阶-指针与内存/ch07-functions/7.6-variable-argument-lists/7.6.2-可变参数的限制.md) 深度覆盖，回链即可 |
...
| `__attribute__` 全族 | [6.6.1](./02-ch2-gnu-c-advanced/6.6-section/6.6.1-GNU-C编译器扩展关键字-__attribute__.md) | [Pointers on C 18.10 深度实测](../02-进阶-指针与内存/ch18-runtime-environment/18.10-GCC属性总览.md) |
| 变参 + format 属性 | [Pointers on C 7.6.2](../02-进阶-指针与内存/ch07-functions/7.6-variable-argument-lists/7.6.2-可变参数的限制.md) | [6.8](./02-ch2-gnu-c-advanced/6.8-format/) |
