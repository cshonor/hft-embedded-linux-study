...
| 章节 | 内容 |
|------|------|
| **[ch01](../03-toolchain/)** | `gcc`、`gdb`、`make` |
| **[ch03](../10-arm-asm-reference/)** | AAPCS、`push`/`pop`、`bl`、`objdump -dS` |
| **[ch04](../04-compile-and-link/)** | ELF `.text/.data/.bss`、`execve`、BSS、动态库 |
...
```bash
cd 00-Linux-Kernel-DPDK-Network-C/05-Kernel-Prep-Embedded-C-Self-Cultivation/05-memory-and-stack/demo
