...
> **本书主线不在这里。** 原第 10 章的嵌入式部分（[10.1 裸机](../02-embedded-c/10.1-bare-metal/)、[10.3 中断](../02-embedded-c/10.3-interrupt/)、[10.8 寄存器](../02-embedded-c/10.8-register/10.8-寄存器操作.md)）已归入 [主线二 · 嵌入式 C 落地](../02-embedded-c/)。
...
| 章节 | 内容 |
|------|------|
| **[ch03](../10-arm-asm-reference/)** | ARM 汇编、`stmfd`/`ldmfd`、栈 |
| **[ch05](../05-memory-and-stack/)** | 任务栈、栈溢出、canary |
| **[ch08](../07-oop-in-c/)** | TCB 结构体、ops/vtable |
| **[ch09](../08-modular-c/)** | 分层目录、Makefile、回调解耦 |
...
```bash
cd 00-Linux-Kernel-DPDK-Network-C/05-Kernel-Prep-Embedded-C-Self-Cultivation/09-os-reference/demo
...
| 后置 | 全书 **05-Kernel-Prep-Embedded-C-Self-Cultivation** 完结；可深入 **Linux 内核 / DPDK / 板级 BSP** |

## 小节

- [10.1 多任务的裸机实现](../02-embedded-c/10.1-bare-metal/10.1-多任务的裸机实现.md)
  - [10.1.1 多任务的模拟实现](../02-embedded-c/10.1-bare-metal/10.1.1-多任务的模拟实现.md)
  - [10.1.2 改变任务的执行频率](../02-embedded-c/10.1-bare-metal/10.1.2-改变任务的执行频率.md)
  - [10.1.3 改变任务的执行时间](../02-embedded-c/10.1-bare-metal/10.1.3-改变任务的执行时间.md)
...
- [10.3 中断](../02-embedded-c/10.3-interrupt/10.3-中断.md)
  - [10.3.1 中断处理流程](../02-embedded-c/10.3-interrupt/10.3.1-中断处理流程.md)
  - [10.3.2 进程栈与中断栈](../02-embedded-c/10.3-interrupt/10.3.2-进程栈与中断栈.md)
  - [10.3.3 中断函数的实现](../02-embedded-c/10.3-interrupt/10.3.3-中断函数的实现.md)
...
- [10.8 寄存器操作](../02-embedded-c/10.8-register/10.8-寄存器操作.md)
  - [10.8.1 位运算应用](../02-embedded-c/10.8-register/10.8.1-位运算应用.md)
  - [10.8.2 操作寄存器](../02-embedded-c/10.8-register/10.8.2-操作寄存器.md)
  - [10.8.3 位域](../02-embedded-c/10.8-register/10.8.3-位域.md)
