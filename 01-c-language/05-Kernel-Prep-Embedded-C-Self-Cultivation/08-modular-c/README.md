...
| 章节 | 内容 |
|------|------|
| **[ch01](../03-toolchain/)** | Makefile、CMake、Git |
| **[ch04](../04-compile-and-link/)** | 静/动态库、链接、符号 |
| **[ch06](../01-gnu-c-extensions/)** | **`weak`/`alias`**、宏 |
| **[ch07](../06-pointers-and-data/)** | 结构体、指针 |
| **[ch08](../07-oop-in-c/)** | 不透明类型、**ops/vtable**、分层 |
