...
| 章节 | 内容 |
|------|------|
| **[ch05](../05-memory-and-stack/)** | 堆/栈、`malloc`/`free`、对象生命周期 |
| **[ch06](../01-gnu-c-extensions/)** | `container_of`、`weak`/`alias`、指定初始化 |
| **[ch07](../06-pointers-and-data/)** | 结构体指针、`typedef`、**7.12 函数指针** |
...
```bash
cd 00-Linux-Kernel-DPDK-Network-C/05-Kernel-Prep-Embedded-C-Self-Cultivation/07-oop-in-c/demo
