...
> **本书主线不在这里。** 原 3.1–3.5 / 3.9（指令/寻址/伪指令/异常）已物理删除，[3.6 内联汇编](../01-gnu-c-extensions/3.6-mixed-programming/) 归入主线一、[3.7 GNU ARM 工具链](../02-embedded-c/3.7-gnu-arm/) 归入主线二。
...
| 章节 | 内容 |
|------|------|
| **[ch01](../03-toolchain/)** | `gcc`、`gdb`、`objdump`、`make`、交叉编译概念 |
| **[10.8 嵌入式 C 开门](../02-embedded-c/10.8-register/10.8-寄存器操作.md)** | 读得懂 MMIO 的 C 表达；原 ch02 硬件内容已删 |
...
```bash
cd 00-Linux-Kernel-DPDK-Network-C/05-Kernel-Prep-Embedded-C-Self-Cultivation/10-arm-asm-reference/demo
...
| **GNU 语法** | 3.7 | `.section` 直接对应 [ch04 链接脚本](../04-compile-and-link/)；读懂 `objdump -dS` 是验证 C 优化的刚需 |
| **AArch64** | 3.8 | 选读：X0–X30、无 Thumb；与 [递归栈帧实测](../../02-Pointers-on-C/ch07-functions/7.5-recursion/7.5-递归.md) 里的 AArch64 对照 |
...
5. `.section` 伪操作与链接脚本里的段如何对应（→ [ch04](../04-compile-and-link/)）
...
- **A 档** [3.6 C语言和汇编语言混合编程](../01-gnu-c-extensions/3.6-mixed-programming/3.6-C语言和汇编语言混合编程.md)
  - [3.6.1 ATPCS规则](../01-gnu-c-extensions/3.6-mixed-programming/3.6.1-ATPCS规则.md)
  - [3.6.2 在C程序中内嵌汇编代码](../01-gnu-c-extensions/3.6-mixed-programming/3.6.2-在C程序中内嵌汇编代码.md)
  - [3.6.3 在汇编程序中调用C程序](../01-gnu-c-extensions/3.6-mixed-programming/3.6.3-在汇编程序中调用C程序.md)
- [3.7 GNU ARM汇编语言](../02-embedded-c/3.7-gnu-arm/3.7-GNU-ARM汇编语言.md)
  - [3.7.1 重新认识编译器](../02-embedded-c/3.7-gnu-arm/3.7.1-重新认识编译器.md)
  - [3.7.2 GNU ARM编译器的伪操作](../02-embedded-c/3.7-gnu-arm/3.7.2-GNU-ARM编译器的伪操作.md)
  - [3.7.3 GNU ARM汇编语言中的标号](../02-embedded-c/3.7-gnu-arm/3.7.3-GNU-ARM汇编语言中的标号.md)
  - [3.7.4 .section伪操作](../02-embedded-c/3.7-gnu-arm/3.7.4-section伪操作.md)
  - [3.7.5 基本数据格式](../02-embedded-c/3.7-gnu-arm/3.7.5-基本数据格式.md)
  - [3.7.6 数据定义](../02-embedded-c/3.7-gnu-arm/3.7.6-数据定义.md)
  - [3.7.7 汇编代码分析实战](../02-embedded-c/3.7-gnu-arm/3.7.7-汇编代码分析实战.md)
...
[10.8 嵌入式 C 开门](../02-embedded-c/10.8-register/10.8-寄存器操作.md)。
