...
> 读 [主线一 6.4 container_of](../01-gnu-c-extensions/6.4-typeof-container-of/6.4-typeof与container_of宏.md) 前建议先看这里的指针运算。
...
| 章节 | 内容 |
|------|------|
| **[ch04](../04-compile-and-link/)** | 编译链接、ELF 段、符号、`readelf`/`nm` |
| **[ch05](../05-memory-and-stack/)** | 栈/堆、`malloc`、对象生命周期 |
| **[ch06](../01-gnu-c-extensions/)** | `packed`/`aligned`、`offsetof`、`container_of`、FAM |
...
```bash
cd 00-Linux-Kernel-DPDK-Network-C/05-Kernel-Prep-Embedded-C-Self-Cultivation/06-pointers-and-data/demo
