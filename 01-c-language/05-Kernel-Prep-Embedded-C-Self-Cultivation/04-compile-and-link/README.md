...
> [4.14 链接脚本](../02-embedded-c/4.14-链接脚本.md) 已归入主线二。这里保留编译/链接主体。
...
| 章节 | 内容 |
|------|------|
| **[ch01](../03-toolchain/)** | `gcc`、`make`、`gdb`、`objdump` |
| ~~ch02 体系结构~~ | 🗑️ 已删，见 [主线二 10.8](../02-embedded-c/10.8-register/10.8-寄存器操作.md) |
| **[ch03](../10-arm-asm-reference/)** | 汇编、`.section`、AAPCS、`objdump -dS` |
...
- [4.14 链接脚本](../02-embedded-c/4.14-链接脚本.md)
