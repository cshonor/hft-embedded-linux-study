...
| 章节 | 内容 |
|------|------|
| **[ch01](../../06-ch6-toolchain-custom/1-toolchain)** | Makefile、CMake、Git |
| **[ch04](../../06-ch6-toolchain-custom/2-compile-and-link)** | 静/动态库、链接、符号 |
| **[ch06](../../01-ch1-gnu-c-basics)** | **`weak`/`alias`**、宏 |
| **[ch07](../7-data-and-pointers)** | 结构体、指针 |
| **[ch08](../8-oop-in-c)** | 不透明类型、**ops/vtable**、分层 |
...
```bash
cd 00-Linux-Kernel-DPDK-Network-C/05-Kernel-Prep-Embedded-C-Self-Cultivation/08-modular-c/demo
