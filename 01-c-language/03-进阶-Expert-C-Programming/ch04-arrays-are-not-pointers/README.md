...
| **[01-C入门-K-and-R-C](../../01-C入门-K-and-R-C/)** | 数组、指针、字符串基础 |
...
```bash
cd 00-Linux-Kernel-DPDK-Network-C/03-进阶-Expert-C-Programming/ch04-arrays-are-not-pointers/demo
...
| 关联 | **[Embedded C ch07](../../04-内核基础-Embedded-C-Self-Cultivation/ch07-data-storage-and-pointers/)** 数据存储、数组名、指针（**7.8**, **7.9**） |
