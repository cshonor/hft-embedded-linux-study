...
| **[01-C入门-K-and-R-C](../../01-C入门-K-and-R-C/)** | 基本声明、指针、数组语法 |
...
```bash
cd 00-Linux-Kernel-DPDK-Network-C/03-进阶-Expert-C-Programming/ch03-analyzing-c-declarations/demo
...
| 关联 | **[Embedded C ch07](../../04-内核基础-Embedded-C-Self-Cultivation/ch07-data-storage-and-pointers/)** 指针、存储、MMIO |
