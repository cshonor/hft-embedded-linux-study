...
| **[01-C入门-K-and-R-C](../../01-C入门-K-and-R-C/)** | 函数、作用域、多文件编译基础 |
...
```bash
cd 00-Linux-Kernel-DPDK-Network-C/03-进阶-Expert-C-Programming/ch05-thinking-of-linking/demo
...
| 关联 | **[Embedded C](../../04-内核基础-Embedded-C-Self-Cultivation/)** 启动代码、链接脚本、裸机 |
