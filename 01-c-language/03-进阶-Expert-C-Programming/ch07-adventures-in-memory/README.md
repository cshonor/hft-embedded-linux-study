...
```bash
cd 00-Linux-Kernel-DPDK-Network-C/03-进阶-Expert-C-Programming/ch07-adventures-in-memory/demo
...
| 关联 | **[Embedded C](../../04-内核基础-Embedded-C-Self-Cultivation/)** 裸机对齐、链接脚本 |
