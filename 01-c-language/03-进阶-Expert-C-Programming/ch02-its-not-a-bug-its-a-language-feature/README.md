...
| **[01-C入门-K-and-R-C](../../01-C入门-K-and-R-C/)** | 基本 C 语法；本章不教语法，教 **陷阱** |
...
```bash
cd 00-Linux-Kernel-DPDK-Network-C/03-进阶-Expert-C-Programming/ch02-its-not-a-bug-its-a-language-feature/demo
...
| 关联 | **[Embedded C](../../04-内核基础-Embedded-C-Self-Cultivation/)** ch04 链接、ch06 GNU 扩展、ch07 指针 |
