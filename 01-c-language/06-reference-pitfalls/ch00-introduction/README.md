...
4. **实现定义/未定义**：同一源码不同编译器/优化等级结果不同（与 [Expert C ch08](../../03-expert-linking-and-memory/ch08-halloween-vs-christmas/) 序列点问题呼应）
...
| **深化** | [03-expert-linking-and-memory](../../03-expert-linking-and-memory/) | 链接、指针、表达式 UB |
