...
4. **实现定义/未定义**：同一源码不同编译器/优化等级结果不同（与 [Expert C ch08](../../03-expert-declarations-and-linking/ch08-halloween-vs-christmas/) 序列点问题呼应）
...
| **配套** | [01-basics-syntax-and-types](../../01-basics-syntax-and-types/) | 语法基础 |
| **深化** | [03-expert-declarations-and-linking](../../03-expert-declarations-and-linking/) | 链接、指针、表达式 UB |
