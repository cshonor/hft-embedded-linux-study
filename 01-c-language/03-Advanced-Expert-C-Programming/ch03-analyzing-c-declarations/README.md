...
| **[01-Primer-K-and-R-C](../../01-Primer-K-and-R-C/)** | 基本声明、指针、数组语法 |
...
```bash
cd 00-Linux-Kernel-DPDK-Network-C/03-Advanced-Expert-C-Programming/ch03-analyzing-c-declarations/demo
...
| 关联 | **[Embedded C ch07](../../05-Kernel-Prep-Embedded-C-Self-Cultivation/05-ch5-portable-modular/7-data-and-pointers/)** 指针、存储、MMIO |
