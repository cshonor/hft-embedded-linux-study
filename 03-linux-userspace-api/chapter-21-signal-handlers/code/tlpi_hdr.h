...
*                                                                         *
*  这是它的**最小替身**，只为本目录下「原书 Ch21 程序」（nonreentrant.c /  *
*  sigmask_longjmp.c / t_sigaltstack.c / nonatomic_uint64.c）能零改动编译  *
*  而存在。                                                                *
*                                                                         *
*  原书真实文件有两层，本仓库都没有随附：                                  *
...
*                                                                         *
*  ⚠️ 与其他章的同名替身**不通用**：                                     *
*     - 本 Ch21 那份含 get_num.h（与 Ch18/19/20 那份同构）；            *
*     - sigmask_longjmp.c 的 printSigMask 来自 Listing 20-4 的             *
*       signal_functions.{c,h}（跨章依赖，已随本目录镜像）。             *
*     别跨章复制粘贴。                                                     *
*                                                                         *
...
#include "get_num.h"   /* 原书 tlpi_hdr.h 也含它；与 Ch18/19/20 替身同构 */
