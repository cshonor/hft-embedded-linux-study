...
*                                                                         *
*  这是它的**最小替身**，只为本目录下「原书 Ch19 程序」（demo_inotify.c  *
*  / dnotify.c / inotify_dtree.c / rand_dtree.c）能零改动编译而存在。      *
*                                                                         *
*  原书真实文件有两层，本仓库都没有随附：                                  *
...
*       表，退化成 errno 的 strerror 文本。因为本章各程序里 errExit 只在 *
