...
**文件夹 `05`** · [README](../README.md) · [OUTLINE](./OUTLINE.md) · [CHAPTER-MAP](./CHAPTER-MAP.md) · [READING-LIST](../READING-LIST.md)
...
> 两本读完即可直接上手 TLPI。其余三本（[专家编程](../01-c-language/03-Advanced-Expert-C-Programming/) ch05-07 / [嵌入式自我修养](../01-c-language/05-Kernel-Prep-Embedded-C-Self-Cultivation/) / [C 陷阱与缺陷](../01-c-language/06-Reference-C-Traps-and-Pitfalls/)）是锦上添花，遇到不懂的 C 细节再回翻对应章节即可。
...
| 权限 / 资源 | UID、rlimit |
| Socket 基础 | 进 [UNP](../03.5-unix-network-api/) 前的 Linux 语义 |

深度网络协议 → [UNP](../03.5-unix-network-api/) · [TCP/IP Vol.1](../11-tcpip-protocols/)
...
| [12-PNP](../04-cpp/M2-cpp-network-programming/) · [12-UNP](../03.5-unix-network-api/) | 网络实验与 API 纵深 |
