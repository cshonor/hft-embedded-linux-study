...
> 两本读完即可直接上手 TLPI。其余三本（[专家编程](../01-c-language/03-expert-linking-and-memory/) ch05-07 / [嵌入式自我修养](../01-c-language/05-embedded-kernel-practice/) / [C 陷阱与缺陷](../01-c-language/06-reference-pitfalls/)）是锦上添花，遇到不懂的 C 细节再回翻对应章节即可。
