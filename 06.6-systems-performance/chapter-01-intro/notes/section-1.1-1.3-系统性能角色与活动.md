...
- 与 [14-HFT ch10 延迟测量](../../../14-hft-engineering/chapter-10-延迟测量与基准压测/README.md) 衔接
...
| **内核栈** | 协议栈延迟、锁、cross-NUMA | `perf`、`ftrace` · [13-DPDK bypass](../../../13-dpdk/) |
...
| **端到端** | P50/P99/P999、抖动 tail | 硬件 timestamp / [HFT ch10 延迟测量](../../../14-hft-engineering/chapter-10-延迟测量与基准压测/README.md) |
