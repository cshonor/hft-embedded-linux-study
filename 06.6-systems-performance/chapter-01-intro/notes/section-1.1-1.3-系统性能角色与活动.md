...
- 与 [14-HFT ch10 延迟测量](../../../14-hft-engineering/chapter-10-延迟测量与基准压测.md) 衔接
...
| **端到端** | P50/P99/P999、抖动 tail | 硬件 timestamp / [HFT ch10 延迟测量](../../../14-hft-engineering/chapter-10-延迟测量与基准压测.md) |
