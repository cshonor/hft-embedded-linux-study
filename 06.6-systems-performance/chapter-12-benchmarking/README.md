...
> **HFT：** 微观基准（fio、iperf）只做 **capacity baseline**；策略与端到端延迟靠 **生产级 replay + 应用 span**（→ [14-HFT ch10](../../14-hft-engineering/chapter-09-延迟测量与基准压测/README.md)）。
...
- HFT 压测：[14-HFT ch10](../../14-hft-engineering/chapter-09-延迟测量与基准压测/README.md)
