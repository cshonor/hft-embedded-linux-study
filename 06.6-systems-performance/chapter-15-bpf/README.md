...
> **HFT：** 生产裸机 **bpftrace/BCC 与 perf 并列标配** — off-CPU、run queue、重传、direct reclaim；深度专书 → [06.7-bpf-observability](../../06.7-bpf-observability/)。
...
SysPerf Ch 1–14  →  Ch 15 BPF 总入口
  → 06.7-bpf-observability 全书（紧接 06.6 SysPerf）
...
- XDP：[06.7-BPF note-XDP](../../06.7-bpf-observability/02-bpf-performance-tools/note-XDP与tc-BPF.md) · [13-DPDK 02-Advanced](../../13-dpdk/02-Advanced-Book/notes/note-XDP与DPDK对照.md)
