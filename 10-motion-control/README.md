...
**文件夹 10** · [返回嵌入式支线](../HFT-READING-ROADMAP.md#六嵌入式-linux-支线07–10)

> **定位：** 无人机项目的 **算法内核** — 只学 **控制逻辑**，**不学** STM32 裸机 / FreeRTOS / PCB。  
> **落地：** 全部依托 **ARM-A + 嵌入式 Linux**（[19–23](../HFT-READING-ROADMAP.md#六嵌入式-linux-支线07–10)）。  
...
> 电机 / ESC 理论：**Ch03** 笔记 + datasheet；驱动实现复用 [20 LDD](../09-device-drivers-dt/)。
...
| HFT | 飞控 |
|-----|------|
| [05 绑核 / SCHED_FIFO](../05-linux-kernel/) | 控制线程 **isolcpus** |
| [03 p99 延迟](../06.6-systems-performance/) | 控制环 **周期 jitter** |
| [15 无锁环 / 异步日志](../16-hft-engineering/) | 传感器 → 控制 **低延迟路径** |
| [14 零拷贝思想](../13-dpdk/) | 共享内存传 IMU 批次 |
...
**上一章：** [P5 嵌入式实战](../projects/P5-raspberry-pi-embedded/) · **总路线：** [HFT-READING-ROADMAP §六](../HFT-READING-ROADMAP.md#六嵌入式-linux-支线07–10)
