...
> **HFT：** 常态 **选读**；`offwaketime` 解阻塞链、`kmem`/`slabratetop` 查内核内存、`mlock` 查内核 mutex。优先 **tracepoint** 而非脆弱 kprobe。与 [03-Linux-Kernel-Development](../03-Linux-Kernel-Development/) · [05-Linux-Virtual-Memory-Manager](../05-Linux-Virtual-Memory-Manager/) 对照。  
...
- Ftrace：[chapter-14-ftrace](../../13-Systems-Performance-2nd/chapter-14-ftrace/)
- LKD：[03-Linux-Kernel-Development](../03-Linux-Kernel-Development/)
- Gorman：[05-Linux-Virtual-Memory-Manager](../05-Linux-Virtual-Memory-Manager/)
