...
- [ ] **`runqlat` 是绑核健康度体温计**— dedicated 策略核右尾应极短；与 [SysPerf Ch6](../../13-Systems-Performance-2nd/chapter-06-cpus/) 一致。
...
- SysPerf CPU：[chapter-06-cpus](../../13-Systems-Performance-2nd/chapter-06-cpus/)
- SysPerf BPF 总览：[chapter-15-bpf](../../13-Systems-Performance-2nd/chapter-15-bpf/)
