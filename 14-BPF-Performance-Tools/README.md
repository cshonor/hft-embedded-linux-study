...
> **文件夹 14** · 紧接 [13-Systems-Performance](../13-Systems-Performance-2nd/) · **同样后置**（见 [LEARNING-CHAIN](../LEARNING-CHAIN.md)）。  
...
与 [01-CSAPP](../01-CSAPP-3rd/) · [13-Systems-Performance](../13-Systems-Performance-2nd/) 同一套约定。
...
- **上一本（必读前置）** → [13-Systems-Performance-2nd](../13-Systems-Performance-2nd/) — 读完立刻读本目录
- SysPerf bpftrace 附录 → [02 appendix-C](../13-Systems-Performance-2nd/appendix-C-bpftrace单行命令.md)
- 后续内核/内存/网络 → [03-Linux-Kernel-Development](../03-Linux-Kernel-Development/) · [05-Linux-Virtual-Memory-Manager](../05-Linux-Virtual-Memory-Manager/) · [13-Rosen](../11-Linux-Kernel-Networking/)（读时可回头用 BPF 验证）
