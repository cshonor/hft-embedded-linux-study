...
→ [09-Rosen](../../../13-Linux-Kernel-Networking/) · [04-BPF note-XDP](../../../04-BPF-Performance-Tools/note-XDP与tc-BPF.md)
...
→ [09 Rosen NAPI/softirq](../../../13-Linux-Kernel-Networking/) · [CROSS-MODULE-GUIDE §二](../../CROSS-MODULE-GUIDE.md#二内核网络栈-vs-用户态旁路)
...
→ [10-DPDK](../../../14-DPDK-Low-Latency-Network/) · [02-Advanced XDP note](../../../14-DPDK-Low-Latency-Network/02-Advanced-Book/notes/note-XDP与DPDK对照.md)
