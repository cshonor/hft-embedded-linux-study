...
→ 深化：[chapter-04 硬件](./chapter-04-硬件选型与服务器配置.md) · [chapter-05 OS 调优](./chapter-05-操作系统内核极致调优.md) · [13-DPDK](../18-dpdk/)
...
→ 深化：[chapter-06 网络与协议](./chapter-06-低延迟网络与协议优化.md) · [23-markets-microstructure](../23-markets-microstructure/)
