...
- `13.5-modern-networking/chapter-05-xdp-architecture/`：XDP hook 是 eBPF 的 attach 点
- `13.5-modern-networking/chapter-09-tc-bpf/`：TC BPF 流量分类
- `16-bpf-observability/`：eBPF 可观测性体系
