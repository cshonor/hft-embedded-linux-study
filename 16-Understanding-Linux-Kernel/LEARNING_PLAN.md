...
| **16 ULK** | `task_struct`、runqueue、页表、syscall **在代码里长什么样**？ |
| **06 Gorman** | VM **为什么这样设计**？NUMA/slab/回收 **专深** |
...
| [08-3 MikanOS](../08-system-low-level-hands-on/08-3-mikan-os/) Ch 19–20 | Ch 2/9/10 分页与 syscall |
| [03 BPF](../03-BPF-Performance-Tools/) | Ch 4/7 内核路径理解 |
