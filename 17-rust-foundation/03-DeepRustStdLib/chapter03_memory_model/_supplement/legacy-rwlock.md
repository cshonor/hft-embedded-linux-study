...
> 章索引：[第 3 章](./README.md) · 前：[3.6 Mutex](../3.2.6-maybeuninit-cases.md) · 后：[3.8 PhantomData](../3.8-static-memory.md)
...
- [3.6 Mutex](../3.2.6-maybeuninit-cases.md)
- [3.9 泄漏与循环引用](legacy-leaks-and-cycles.md) — `Arc<RwLock<_>>` 环
