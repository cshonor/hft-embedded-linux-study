...
**文件夹 11** · [返回嵌入式支线](../HFT-READING-ROADMAP.md#六嵌入式-linux-支线07–11)

> **定位：** 无人机项目的 **算法内核** — 只学 **控制逻辑**，**不学** STM32 裸机 / FreeRTOS / PCB。  
> **落地：** 全部依托 **ARM-A + 嵌入式 Linux**（[19–23](../HFT-READING-ROADMAP.md#六嵌入式-linux-支线07–11)）。  
...
| [03 p99 延迟](../15-systems-performance/) | 控制环 **周期 jitter** |
| [15 无锁环 / 异步日志](../17-hft-engineering/) | 传感器 → 控制 **低延迟路径** |
| [14 零拷贝思想](../14-dpdk/) | 共享内存传 IMU 批次 |
