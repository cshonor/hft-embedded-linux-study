...
← [chapter-01 实战启动](../chapter-01-高频交易基础与生态/1.8-实战启动建议.md) · [chapter-09 测量](../chapter-09-延迟测量与基准压测/README.md)
...
**下一章：** [chapter-12 做市与套利](../chapter-12-高频做市与套利策略/README.md) —— 前面所有工程能力的**盈利出口**。

→ [06.6-Systems-Performance](../../../06.6-systems-performance/) · [chapter-10 风控](../chapter-10-风控合规与滑点控制/README.md)
