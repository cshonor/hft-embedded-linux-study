...
← 原理：[chapter-04 硬件到 OS](../chapter-04-hardware-selection-server-config/README.md) · 无锁/内存池：[chapter-07](../chapter-07-lockless-data-structures-memory-layout/README.md)

---

## 本章定位

原书 **Ch6 HFT Optimization（架构与 OS）** 的第一支柱：**消灭上下文切换** — 本章给出 **代价模型 + Linux 实操**；第二、三支柱（无锁、内存池）→ [chapter-07](../chapter-07-lockless-data-structures-memory-layout/README.md)。
...
**下一支柱：** [chapter-07 无锁 + 内存池](../chapter-07-lockless-data-structures-memory-layout/README.md)
