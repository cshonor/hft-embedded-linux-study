...
← 硬件/OS 原理：[chapter-04](../chapter-04-hardware-selection-server-config/README.md) · Bypass 实操：[chapter-05](../chapter-05-os-kernel-tuning/README.md)
...
→ 深化：[13-DPDK](../../../13-dpdk/) · [12-PNP](../../../04-cpp/M2-cpp-network-programming/)
...
**下一步（原书 Ch6 ≈ 软件压榨）：** [chapter-07 无锁与内存](../chapter-07-lockless-data-structures-memory-layout/README.md) · [chapter-05 OS 绑核](../chapter-05-os-kernel-tuning/README.md)
