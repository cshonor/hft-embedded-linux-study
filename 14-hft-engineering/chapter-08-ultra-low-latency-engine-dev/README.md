...
← [chapter-07 无锁环](../chapter-07-lockless-data-structures-memory-layout/README.md) · [chapter-09 测量](../chapter-09-latency-measurement-benchmarking/README.md)
...
| 主题 | 本章 | 交叉 |
|------|------|------|
| 内存模型 / 原子序 | **8.1** | [Ch7 §5](../chapter-07-lockless-data-structures-memory-layout/7.5-CPP内存序.md) |
| 绑核 / Bypass / Hugepage | 8.6 实战 | [Ch5](../chapter-05-os-kernel-tuning/README.md) · [Ch6](../chapter-06-low-latency-network-protocol/README.md) |
| 无锁 IPC | 8.6 实战 | [Ch7 §4](../chapter-07-lockless-data-structures-memory-layout/7.4-共享内存IPC.md) |
| Gateway / Book / OMS | **8.7** | [Ch1 §1](../chapter-01-hft-fundamentals-ecosystem/1.1-系统核心架构.md) |
...
**C++ 性能圣经落地后** → 策略：[chapter-12](../chapter-12-market-making-arbitrage/README.md) · 风控：[chapter-10](../chapter-10-risk-compliance-slippage/README.md)
...
→ [chapter-01 §5 语言选择](../chapter-01-hft-fundamentals-ecosystem/1.5-编程语言选择.md)
