...
← [chapter-12 策略](../chapter-12-高频做市与套利策略/README.md) · [chapter-04 硬件基础](../chapter-04-硬件选型与服务器配置/README.md) · [chapter-03 共址](../chapter-03-订单簿深度与行情解析/3.4-共址与市场数据.md)
...
| 主题 | 本章 | 交叉 |
|------|------|------|
| FPGA 原理速览 | **13.1** | [Ch4 §4](../chapter-04-硬件选型与服务器配置/4.4-硬件选型速查.md) · [Ch1 §7](../chapter-01-高频交易基础与生态/1.7-FPGA纳秒级.md) |
| 传统共址 | — | [Ch3 §4](../chapter-03-订单簿深度与行情解析/3.4-共址与市场数据.md) |
| 云端共址 | **13.3** | [Ch6 网络](../chapter-06-低延迟网络与协议优化/README.md) |
