...
| 步骤 | 内容 | 章节 |
|------|------|------|
| 1 | **架构** Gateway / Book / Strategy / OMS | [Ch1](./chapter-01-高频交易基础与生态/README.md) · [Ch8](./chapter-08-超低延迟核心引擎开发/README.md) |
| 2 | **硬件/OS** 绑核 · BIOS · Hugepage · Bypass | [Ch4 原理](./chapter-04-硬件选型与服务器配置/README.md) · [Ch5 实操](./chapter-05-操作系统内核极致调优/README.md) |
| 3 | **IPC** 无锁 Ring · 内存池 | [Ch7 无锁/内存（原书 Ch6§2–3）](./chapter-07-无锁数据结构与内存布局/README.md) |
| 4 | **语言** C++ / Java / Python 混合 | [Ch8](./chapter-08-超低延迟核心引擎开发/README.md) · [Ch9 Java](./chapter-09-java-jvm-低延迟系统/README.md) · [Ch14 Python（原书 Ch10）](./chapter-14-python-高性能混合架构/README.md) |
...
| 章 | 笔记 | 状态 |
|----|------|------|
| 1 | [chapter-01 基础与生态](./chapter-01-高频交易基础与生态/README.md) | ✅ 总览 |
| 2 | [chapter-02 关键组件](./chapter-02-交易所架构与撮合原理/README.md) | ✅ 要点 |
| 3 | [chapter-03 交易所动态与 LOB](./chapter-03-订单簿深度与行情解析/README.md) | ✅ 要点 |
| 4 | [chapter-04 硬件到 OS](./chapter-04-硬件选型与服务器配置/README.md) | ✅ 要点 |
| 5 | [chapter-05 OS 调优 · 上下文切换（原书 Ch6§1）](./chapter-05-操作系统内核极致调优/README.md) | ✅ 要点 |
...
| 9 | [chapter-09 Java/JVM 低延迟（原书 Ch9）](./chapter-09-java-jvm-低延迟系统/README.md) | ✅ 要点 |
...
| 14 | [chapter-14 Python 混合架构（原书 Ch10）](./chapter-14-python-高性能混合架构/README.md) | ✅ 要点 |
