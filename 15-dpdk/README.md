...
| 08 | [UNP Vol.1](../12-network-sockets/unix-network-api/) | 系统调用 / Socket API | 用户态怎么调内核网络栈？ |
...
- Socket 模型 → [12-network-sockets/unix-network-api](../12-network-sockets/unix-network-api/)、[02-computer-systems Ch11](../02-computer-systems/chapter-11-network-programming/)
