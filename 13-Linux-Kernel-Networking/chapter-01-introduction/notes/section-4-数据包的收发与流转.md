...
> **HFT：** 共置机 **filter/nat 规则过多** 会增 **每包 CPU**；低延迟环境常 **精简 iptables**、**固定路由**，或用 **XDP 早 drop**（→ [04-BPF Ch10 XDP](../../04-BPF-Performance-Tools/chapter-10-networking/)）。
...
| 变化 | 场景 |
|------|------|
| **NAT / IPsec** | 改 IP/端口或加密封装（[Ch 9](../../chapter-09-Netfilter.md) · [Ch 10 IPsec](../../chapter-10-IPsec.md)） |
...
→ 邻居 ARP/ND：[Ch 7](../../chapter-07-邻居子系统.md) · L4 队列与 backlog：[Ch 11](../../chapter-11-第4层协议.md)
