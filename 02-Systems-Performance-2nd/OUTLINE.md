...
> **全书前置（阶段 1）：** [01-CSAPP](../01-CSAPP-3rd/) 地基 + [04-Hennessy](../04-Computer-Architecture-6th/) Ch2 — 再读本目录。
...
→ 深入 BPF → [03-BPF-Performance-Tools](../03-BPF-Performance-Tools/)（**紧接本书**，不必等后续章节）
