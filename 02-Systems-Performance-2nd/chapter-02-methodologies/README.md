...
| 2.6–2.7 建模与容量规划 | [notes/section-2.6-2.7-建模与容量规划.md](./notes/section-2.6-2.7-建模与容量规划.md) |
...
- 排队论：**M/M/1** 单线程报单 ρ≈70% 队列延迟陡增 → 设限流；**M/M/c** 多核撮合 — 见 [2.6–2.7](./notes/section-2.6-2.7-建模与容量规划.md)。
...
- [ ] 理解排队论：**M/M/1** ρ≈70% 拐点、**M/M/c** 多核；容量 **模型→压测→实盘**
- [ ] 知道 **热力图 / 火焰图** 各解决什么问题
