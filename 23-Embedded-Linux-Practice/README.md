...
| [03 SysPerf](../15-Systems-Performance-2nd/) | **量延迟** — 控制环周期 p99 |
| [14 DPDK](../14-DPDK-Low-Latency-Network/) 零拷贝思想 | **DMA / 共享内存** 传 IMU/图传 |
| [16 HFT](../17-HFT-Low-Latency-Practice/) 日志异步 | 黑匣子 / 遥测 **移出热路径** |
...
> **主线不变：** [16 HFT](../17-HFT-Low-Latency-Practice/) 量化开发；本模块为 **第二职业退路**。
