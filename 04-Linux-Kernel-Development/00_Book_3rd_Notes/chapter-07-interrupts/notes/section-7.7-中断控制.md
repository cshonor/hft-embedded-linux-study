...
→ **Ch 9–10** 自旋锁 + `local_irq_save` 组合 · [Ch 8.8](../../chapter-08-bottom-halves/notes/section-8.8-锁定与禁用下半部.md) `local_bh_disable` · [01 Day 14 临界区](../../../../08-system-low-level-hands-on/02-30days-os/day-14-keyboard/)
