...
→ [06 Gorman Ch8 Slab](../../../../06-Linux-Virtual-Memory-Manager/chapter-08-slab-allocator/) · [Ch 3 task_struct Slab](../../chapter-03-process-management/) · [Ch 12.10 per-CPU](./section-12.10-每个-CPU-的分配.md)
