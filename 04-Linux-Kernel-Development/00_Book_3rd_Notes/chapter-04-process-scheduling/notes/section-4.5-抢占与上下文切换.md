...
| 谁置位 | 定时器 tick、唤醒更高优先级、显式 `set_need_resched` 等 |
...
→ **Ch 1** 宏内核+抢占 · [01 Day 16 多任务](../../../../08-system-low-level-hands-on/02-30days-os/day-16-multitask2/) · [4.6 RT](./section-4.6-实时调度策略.md)
