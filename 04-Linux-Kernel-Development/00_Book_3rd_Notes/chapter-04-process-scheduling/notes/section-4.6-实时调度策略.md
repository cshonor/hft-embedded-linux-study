...
| 硬实时 | 需专用 RTOS 或 `PREEMPT_RT` + 严格系统工程 |
...
→ [07 TLPI Ch 34–37](../../../../07-The-Linux-Programming-Interface/) · [4.7 syscall](./section-4.7-与调度相关的系统调用.md) · [17 HFT Practice](../../../../17-HFT-Low-Latency-Practice/)
