...
**07-system-low-level-hands-on** 子模块 · [返回 09 总览](../README.md)
...
**读完能带走什么：** 现代 PC 上的 **UEFI 启动链、长模式、页表、APIC、系统调用** — 与 [01-CSAPP](../../01-CSAPP-3rd/chapter-09-virtual-memory/) · [03-Linux-Kernel-Development](../../03-Linux-Kernel-Development/) · [06-The-Linux-Programming-Interface](../../06-The-Linux-Programming-Interface/) 对照时，不再只是「读源码」，而是知道 **这些机制从零怎么搭**。
...
**交叉：** [01-CSAPP](../01-CSAPP-3rd/) Ch 9 虚拟内存 · [02-Hennessy](../02-Computer-Architecture-6th/) · [06-The-Linux-Programming-Interface](../06-The-Linux-Programming-Interface/) 进程/内存 API 对照。
...
| [03-Linux-Kernel-Development](../../03-Linux-Kernel-Development/) | 中断、调度、syscall 真实实现 |
| [06-The-Linux-Programming-Interface](../../06-The-Linux-Programming-Interface/) | 用户态 API 边界 |
