...
| 「和汇编无关」 | [1.3](./section-1.3-初次体验汇编程序.md) 用 `helloos.asm` 生成 **相同 img** |
...
Copy-Item -Force "<本仓库>\07-system-low-level-hands-on\02-30days-os\day-01-boot-asm\code\helloos.img" "D:\haribote\boot.img"
