...
> **HFT 阶段 1：** 先读 **Ch2**（配合 [01-CSAPP Ch6](../02-computer-systems/chapter-06-memory-hierarchy/)），再读 [14-Systems-Performance](../19-systems-performance/)。Ch5 内存一致性可与 CSAPP Ch12 交叉。
