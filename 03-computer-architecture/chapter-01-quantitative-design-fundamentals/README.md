...
→ 与 [01-CSAPP Ch1 §1.9 Amdahl](../../02-computer-systems/chapter-01-tour-of-computer-systems/notes/section-1.9-重要主题-Amdahl与并发与抽象.md) 交叉 · 深入内存 → [Ch 2](../chapter-02-memory-hierarchy-design/)
