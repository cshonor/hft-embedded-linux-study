...
| | |
|---|---|
| **本章干什么** | 实现 **Console 类** 与 **printk**；在帧缓冲上 **格式化文本**；接入 **Newlib** 铺垫。 |
| **全书作用** | **可观测性** — 内核日志与调试输出；GUI 之前先解决「屏幕上读文字」— 贯穿后续所有章的排错手段。 |
| **← 前置** | [Ch4 像素绘图](../chapter-04-pixel-make/) |
| **→ 后续** | [Ch6 鼠标 / PCI](../chapter-06-mouse-pci/) — 从输出扩展到输入设备 |
