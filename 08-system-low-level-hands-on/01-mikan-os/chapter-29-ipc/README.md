...
| | |
|---|---|
| **本章干什么** | **管道 pipe** · **sort / cat** 优化 · **WaitFinish** · 应用间 **数据流**。 |
| **全书作用** | **进程间通信**（🟡）— Unix 管道最小实现；多应用协作（shell 管道）的收官。 |
| **← 前置** | [Ch26–28 文件与重定向](../chapter-26-app-write-file/) |
| **→ 后续** | [Ch30 额外应用](../chapter-30-extra-apps/) |
