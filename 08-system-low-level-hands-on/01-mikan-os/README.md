...
**08-system-low-level-hands-on** 子模块 · [返回 09 总览](../README.md)

> **父模块：** [08-system-low-level-hands-on](../README.md)  
> **原著：** 内田公太（uchan）· **《从零自制操作系统》**（日版 *ゼロからの OS 自作入門*）  
> **本仓库：** HFT 学习链裁剪笔记 + 实验记录（非全书翻译）  
> **HFT 路线定位：** 🔴 **09 模块 OS 动手主线** — C 达标后 **直接从这里开**，不必先做完 [02 30 天](../02-30days-os/)  
...
| **语言栈** | **C++** + **EDK II**（与 [02 30 天](../02-30days-os/) 的 32 位 BIOS/C 路线互补） |

**读完能带走什么：** 现代 PC 上的 **UEFI 启动链、长模式、页表、APIC、系统调用** — 与 [01-CSAPP](../../01-CSAPP-3rd/chapter-09-virtual-memory/) · [04-Linux-Kernel-Development](../../04-Linux-Kernel-Development/) · [07-The-Linux-Programming-Interface](../../07-The-Linux-Programming-Interface/) 对照时，不再只是「读源码」，而是知道 **这些机制从零怎么搭**。

---

## 在本学习链中的定位

> **定位：** **现代 64 位 UEFI OS** — **HFT / 服务器底层主线**；与 [02 30 天](../02-30days-os/)（BIOS 软盘启蒙）**互补但不前置依赖**。
...
**标签：** 🔴 HFT 主线 OS 动手 · 🟡 通用路线可在 02 30 天之后开
...
| 路线 | 顺序 |
|------|------|
| **HFT / 嵌入式 Linux** | **C 达标 → 直接 01 MikanOS**；02 30 天后置或不学 |
| **通用零基础** | 02 30 天 Day 1–15 或通读 → 再开 01 MikanOS |

详 **[HFT-AND-EMBEDDED-PRIORITY.md](../HFT-AND-EMBEDDED-PRIORITY.md)**。

**交叉：** [01-CSAPP](../01-CSAPP-3rd/) Ch 9 虚拟内存 · [02-Hennessy](../03-Computer-Architecture-6th/) · [07-The-Linux-Programming-Interface](../07-The-Linux-Programming-Interface/) 进程/内存 API 对照。

---

## 目录结构

与 [02 30 天 OS](../02-30days-os/) · [14-Systems-Performance](../../15-Systems-Performance-2nd/) 一致：每章独立目录，导读 + 分段笔记。
...
| **08** | 窗口 | [chapter-10-window](./chapter-10-window/) |
| **09** | 定时器和 ACPI | [chapter-11-timer-acpi](./chapter-11-timer-acpi/) |
| **10** | 键盘输入 | [chapter-12-keyboard](./chapter-12-keyboard/) |
| **11** | 多任务处理（1） | [chapter-13-multitask1](./chapter-13-multitask1/) |
| **12** | 多任务处理（2） | [chapter-14-multitask2](./chapter-14-multitask2/) |
...
| 仓库 | 对照点 |
|------|--------|
| [02 30 天 OS](../02-30days-os/) | BIOS 实模式 → 保护模式（建议先读 Day 1–15） |
| [01-CSAPP Ch9](../../01-CSAPP-3rd/chapter-09-virtual-memory/) | 虚拟内存 |
| [04-Linux-Kernel-Development](../../04-Linux-Kernel-Development/) | 中断、调度、syscall 真实实现 |
| [07-The-Linux-Programming-Interface](../../07-The-Linux-Programming-Interface/) | 用户态 API 边界 |
