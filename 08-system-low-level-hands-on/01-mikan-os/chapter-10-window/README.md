...
| | |
|---|---|
| **本章干什么** | **Window 类** · **局部重绘** · **后置缓冲区**；减轻闪烁与全屏刷新成本。 |
| **全书作用** | **GUI 交互壳** — 从「能合成」到「像桌面」；Ch12 键盘、Ch15 终端的焦点/活动窗建立在此。 |
| **← 前置** | [Ch9 LayerManager](../chapter-09-layers/) |
| **→ 后续** | [Ch11 定时器 / ACPI](../chapter-11-timer-acpi/) — 为动画与调度引入时间 |
