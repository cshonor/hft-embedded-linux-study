...
| | |
|---|---|
| **本章干什么** | 解析 **UEFI Memory Map**；迁移栈/GDT；**四级页表身份映射**；**位图页帧分配器**。 |
| **全书作用** | **内核骨架 · 物理内存**（🔴）— 脱离 UEFI 分配；Ch2「只读 map」在此变为 **Allocate/Free**；Ch19 进程页表的前置。 |
| **← 前置** | [Ch2 memmap](../chapter-02-edk2-memmap/) + [Ch7 中断](../chapter-07-interrupt-fifo/) |
| **→ 后续** | [Ch9 图层合成](../chapter-09-layers/) — 在稳定内存之上做 GUI |
