...
| | |
|---|---|
| **本章干什么** | **Task / TaskManager** · **协作式多任务** · 上下文切换；多个 Task **主动让出 CPU**。 |
| **全书作用** | **内核骨架 · 多任务入门**（🔴）— 从单线程主循环到「多个执行流」；对照 02 川合 `switch_task`。 |
| **← 前置** | [Ch7 中断](../chapter-07-interrupt-fifo/) + [Ch11 定时器](../chapter-11-timer-acpi/) |
| **→ 后续** | [Ch14 多任务（2）](../chapter-14-multitask2/) — 抢占与优先级 |
...
| 与 Linux / CSAPP 对照？ | `context_switch` / `schedule` 雏形 — [04-Linux-Kernel-Development](../../../04-Linux-Kernel-Development/) · [ULK Ch7 调度](../../../05-Understanding-Linux-Kernel/chapter-07-process-scheduling.md) |
