...
| | |
|---|---|
| **本章干什么** | **FAT12/16/32** · **BPB** · **UEFI Block I/O** · **`ls`**；卷镜像与目录项。 |
| **全书作用** | **持久化与 VFS 雏形**（🟡）— 从内存态到磁盘文件；Ch25–26 用户态读写文件、Ch18 加载应用都依赖本章。 |
| **← 前置** | [Ch16 命令](../chapter-16-commands/) |
| **→ 后续** | [Ch18 应用 / ELF](../chapter-18-apps/) — 加载用户程序 `cat.elf` |
