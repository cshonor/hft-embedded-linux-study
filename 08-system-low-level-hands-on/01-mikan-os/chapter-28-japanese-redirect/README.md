...
| | |
|---|---|
| **本章干什么** | **FreeType** 矢量字体 · **日文显示** · **stdout 重定向** · 栈扩容排错。 |
| **全书作用** | **i18n + shell 重定向** — 把 Ch16 命令行能力扩展到 **> file**；展示复杂用户态应用的内存压力。 |
| **← 前置** | [Ch27 应用内存](../chapter-27-app-memory/) + [Ch5 Newlib](../chapter-05-console-text/) |
| **→ 后续** | [Ch29 IPC / 管道](../chapter-29-ipc/) |
