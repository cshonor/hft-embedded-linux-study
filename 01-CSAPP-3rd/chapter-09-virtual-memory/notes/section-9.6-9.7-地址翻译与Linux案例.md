...
- **透明大页 THP** — 内核自动 4K 合并 2M；**延迟敏感** 常 **显式 hugepage** 或关 THP（→ [note-THP](../../../06-Linux-Virtual-Memory-Manager/note-透明大页THP.md)）
...
- **`mbind`/`set_mempolicy`** — NUMA 本地分配（→ [02-SysPerf Ch7](../../../02-Systems-Performance-2nd/chapter-07-memory/)）
