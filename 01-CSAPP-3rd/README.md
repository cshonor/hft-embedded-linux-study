...
> **机器级默认架构：** **x86-64 + Linux System V + AT&T gas**（Ch3 起）；**HFT 只练 AT&T，不学 Intel 语法**。Ch4 **Y86-64** 仅为流水线教学子集。ARM 对照 → [19-ARM64](../19-ARM64-Architecture/)。
...
→ 读完地基再读 [14-Systems-Performance](../15-Systems-Performance-2nd/) · Hennessy 理论 → [03-Computer-Architecture-6th](../03-Computer-Architecture-6th/)
