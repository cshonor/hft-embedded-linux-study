...
> **不是 Verilog：** 本章用 **HCL** 描述控制；Verilog 在 Harris Ch4（嵌入式 Linux 路线可跳）。路线对照 → [学习路线_CSAPP与Harris](../../../24-Digital-Design-Harris-ARM/学习路线_CSAPP与Harris_Linux驱动.md)
...
| **4.2** HCL 与组合电路 | [section-4.2-HCL逻辑与组合电路.md](./notes/section-4.2-HCL逻辑与组合电路.md) | 组合(mux/ALU) vs 时序(寄存器/PC/内存)；HCL 纯教具；SEQ 电路积木 |
| **4.3** SEQ 顺序处理器 | [section-4.3-SEQ顺序处理器.md](./notes/section-4.3-SEQ顺序处理器.md) | 单周期五级 F→D→E→M→W，一条走完才下一条；资源闲置→引出流水线 |
...
| **Harris ARM（独立书仓）** | [../../../24-Digital-Design-Harris-ARM/](../../../24-Digital-Design-Harris-ARM/README.md) | 已从本 notes 提出：一章一夹、一小节一文件 |
...
- **数字电路补课：** [资料总表](./notes/section-补充-数字电路学习资料.md) · **[24-Harris ARM 独立书仓](../../../24-Digital-Design-Harris-ARM/README.md)**
