...
1. **主力：** [25-Harris ARM](../../../25-Digital-Design-Harris-ARM/README.md) — 精读 Ch2.8–2.9 / Ch3 / Ch5 / Ch6 / **Ch7.5** / Ch8；**跳过 Ch4**  
2. Logisim 实操  
3. 可选 *Code* / [MIT 6.004](https://computationstructures.org)  
4. 拔高：[Hennessy](../../../03-Computer-Architecture-6th/)  

> **目录钉死：** Ch5=数字模块，Ch6=ARM 体系结构，Ch7=微结构(流水线)，Ch8=存储器，**在线 Ch9=I/O**。笔记已独立到仓库根目录 `25-Digital-Design-Harris-ARM/`。
