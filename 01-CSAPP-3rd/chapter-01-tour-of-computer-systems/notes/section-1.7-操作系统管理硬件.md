...
- 深入 → [Ch 12 并发编程](../../chapter-12-并发编程.md)
...
- **NUMA：** 分配与访问同节点（→ [Ch 9](../../chapter-09-虚拟内存.md)、[06-Gorman](../../../06-Linux-Virtual-Memory-Manager/)）
...
- 行情/订单：**socket 也是文件描述符** — `epoll` 等多路复用（→ [Ch 10–11](../../chapter-10-系统级IO.md)、[08-UNP](../../../08-UNP-Vol1/)）
