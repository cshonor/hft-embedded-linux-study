...
- **NUMA：** 分配与访问同节点（→ [Ch 9](../../chapter-09-virtual-memory/)、[05-Linux-Virtual-Memory-Manager](../../../05-Linux-Virtual-Memory-Manager/)）
...
- 行情/订单：**socket 也是文件描述符** — `epoll` 等多路复用（→ [Ch 10–11](../../chapter-10-system-io/)、[09-UNP](../../../09-UNP-Vol1/)）
