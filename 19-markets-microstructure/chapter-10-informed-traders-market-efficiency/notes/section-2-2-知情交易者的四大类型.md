...
| 类型 | 英文 | 信息用法 | 速度特征 | 专章 |
|------|------|----------|----------|------|
| **价值交易者** | Value traders | **自下而上** 估 **绝对** 基本面；研究团队 + 多层审查 | **通常慢** | [Ch 16](../../chapter-16-value-traders/) |
...
| **套利者** | Arbitrageurs | **相对价值**；买便宜卖贵，赌 **关系回归**；强制执行 **一价定律** | 中–快 | [Ch 17](../../chapter-17-arbitrageurs/) |
