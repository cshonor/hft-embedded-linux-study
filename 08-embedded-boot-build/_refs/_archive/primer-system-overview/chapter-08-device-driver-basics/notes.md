...
**C 语言：** 标准 C 为根 — [struct 驱动向](../../../01-c-language/01-basics-syntax-and-types/ch06-structures/6.0-struct-for-drivers.md)；高频 GNU 见 [速查表](../../../01-c-language/05-embedded-kernel-practice/01-ch1-gnu-c-basics/DRIVER-GNU-C-CHEATSHEET.md) · [学多少](../../../01-c-language/05-embedded-kernel-practice/01-ch1-gnu-c-basics/1.0-driver-how-much-gnu-c.md)  
