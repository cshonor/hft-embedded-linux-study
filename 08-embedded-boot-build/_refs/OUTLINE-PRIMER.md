...
> 读序：本书 → [MELP](.../) · 重合说明：[FOUR-BOOKS-OVERLAP](./FOUR-BOOKS-OVERLAP.md)
...
| 7.5 DTB | DTS→dtb；UEFI 对位是 U-Boot 而非 DTS，见 [FAQ](../01-orientation/1.6-device-tree-vs-uefi.md)；接 [09 驱动/DT](../../09-device-drivers-dt) | **精读** |
