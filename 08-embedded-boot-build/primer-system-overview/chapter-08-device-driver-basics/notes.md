...
**C 语言：** 标准 C 为根 — [struct 驱动向](../../../01-c-language/01-Primer-K-and-R-C/ch06-structures/6.0-struct-for-drivers.md)；高频 GNU 见 [速查表](../../../01-c-language/05-Kernel-Prep-Embedded-C-Self-Cultivation/ch06-gnu-c-extensions/DRIVER-GNU-C-CHEATSHEET.md) · [学多少](../../../01-c-language/05-Kernel-Prep-Embedded-C-Self-Cultivation/ch06-gnu-c-extensions/6.0-driver-how-much-gnu-c.md)  
