...
> **内核：** 约 **2.6.10**（2005）  
> **大纲：** [refs/classic-driver-theory/OUTLINE.md](./refs/classic-driver-theory/OUTLINE.md)（18 章）  
> 四书代号 **C**：[FOUR-BOOKS-OVERLAP](../11-embedded-boot-build/FOUR-BOOKS-OVERLAP.md)
...
| 书 | 角色 |
|----|------|
| [Embedded Linux Primer](../11-embedded-boot-build/primer-system-overview/) | 系统全景：Boot / rootfs / 交叉环境 |
| [Madieu](./refs/modern-driver-practice/) | ARM · DTS · I2C/SPI/GPIO **实操**（树莓派主书） |
