...
>
> **后续：**
> - [09-linux-mm](../09-linux-mm/)（内存管理子系统，调试 MM 问题时回来查）
> - [19-systems-performance](../19-systems-performance/)（性能分析，从"正确性"转向"性能"）
> - [20-bpf-observability](../20-bpf-observability/)（eBPF 动态追踪，从"调试"转向"可观测"）

---

## ⚠️ 与 19-systems-performance / 20-bpf-observability 的边界
...
与 [07-linux-kernel](../07-linux-kernel/) · [08-linux-kernel-deep](../08-linux-kernel-deep/) · [19-systems-performance](../19-systems-performance/) · [20-bpf-observability](../20-bpf-observability/) 同一套约定。
