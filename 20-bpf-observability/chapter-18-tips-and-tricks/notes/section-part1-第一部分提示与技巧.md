...
**HFT：** 复现 **单 syscall、单 connect** 的 microbench，再挂 BPF — 与 [16-HFT ch10 压测](../21-hft-engineering/chapter-10-延迟测量与基准压测.md) 同思路。
...
→ [04-linux-userspace-api](../04-linux-userspace-api/) · [Ch 5 bpftrace](../../chapter-05-bpftrace/)
