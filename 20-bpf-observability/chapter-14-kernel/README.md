...
> **HFT：** 常态 **选读**；`offwaketime` 解阻塞链、`kmem`/`slabratetop` 查内核内存、`mlock` 查内核 mutex。优先 **tracepoint** 而非脆弱 kprobe。与 [07-linux-kernel](../07-linux-kernel/) · [09-linux-mm](../09-linux-mm/) 对照。  
...
- Ftrace：[chapter-14-ftrace](../../19-systems-performance/chapter-14-ftrace/)
- LKD：[07-linux-kernel](../07-linux-kernel/)
- Gorman：[09-linux-mm](../09-linux-mm/)
