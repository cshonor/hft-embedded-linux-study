...
| 规则 | 作用 |
|------|------|
| **时间优先 + 较大 tick size** | [Ch 6](../../chapter-06-order-driven-markets/) · [Ch 11](../../chapter-11-order-anticipators/) — penny jump **成本↑** → 保护 **敢暴露的 LP** |
| **未公开指令 (Undisclosed / Iceberg)** | **隐藏规模** 下提供流动性 |
| **延迟交易报告 (Delayed trade reporting)** | 大宗 **建仓/平仓** 完成前 **少被发觉**、少被 front-run |

→ [Ch 15 print / clean up](../../chapter-15-block-traders/)
