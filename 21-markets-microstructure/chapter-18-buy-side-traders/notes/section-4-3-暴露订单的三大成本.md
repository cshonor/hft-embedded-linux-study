...
→ [Ch 8](../../chapter-08-why-people-trade/) · [Ch 15 动机审计](../../chapter-15-block-traders/)

### 3.2 泄露未来价格冲击 (Reveal Future Price Impacts)

| 逻辑 | 大且急 → **势必推价** |
|------|----------------------|
| **后果** | [Ch 11 Front runners](../../chapter-11-order-anticipators/) **抢先同向** → **加剧冲击** → **提高大交易者成本** |
...
| 机制 | 挂限价单 = 送 **免费交易期权** — [Ch 4](../../chapter-04-orders-and-order-types/) |
|------|-----------------------------------------------------------------------------|
| **Quote matchers** | 在大单前 **penny jump** — 有利则赚，不利则 **甩给身后大单** |

→ [Ch 11 §2.1B](../../chapter-11-order-anticipators/)
