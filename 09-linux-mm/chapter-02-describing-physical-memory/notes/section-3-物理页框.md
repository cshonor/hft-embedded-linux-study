...
→ 用户态 `mmap` 的文件页、匿名页，最终都落实为 **`struct page` + 引用计数 + flags**（→ [04-linux-userspace-api](../04-linux-userspace-api/) · [07-linux-kernel Ch12](../07-linux-kernel/00_Book_3rd_Notes/chapter-12-memory-management/)）。
