...
- 内核侧同类原语 → [ULK Ch5 §3 基础同步原语](../../../08-linux-kernel-deep/chapter-05-kernel-synchronization/notes/section-3-基础同步原语.md)  
- 内存序 / 屏障 → [01-CSAPP](../../../02-computer-systems/) · [Ch2 Cache 一致性](../chapter-02-cache-and-memory/notes/section-4-Cache一致性与无锁设计.md)
