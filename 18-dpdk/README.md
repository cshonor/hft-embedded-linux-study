...
| 序号 | 文件夹 | 层级 | 回答的问题 |
|------|--------|------|-----------|
| 07 | [TCP/IP Illustrated Vol.1](../16-tcpip-protocols/) | 协议 | 线上包长什么样？ |
| 08 | [UNP Vol.1](../15-network-sockets/unix-network-api/) | 系统调用 / Socket API | 用户态怎么调内核网络栈？ |
...
- 内核栈对照 → [17-kernel-networking](../17-kernel-networking/)
- Socket 模型 → [15-network-sockets/unix-network-api](../15-network-sockets/unix-network-api/)、[02-computer-systems Ch11](../02-computer-systems/chapter-11-network-programming/)
- 缓存 / 内存 → [02-computer-systems Ch6](../02-computer-systems/chapter-06-memory-hierarchy/)、[03-computer-architecture](../03-computer-architecture/)
- 生产观测 → [20-bpf-observability](../20-bpf-observability/)
- 工程落地 → [21-hft-engineering](../21-hft-engineering/)
