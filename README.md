...
| **01.7** | [platform-toolchain](./01.7-platform-toolchain/) | 三条 C 工具链互译：公共认知层 → Windows/MSVC → macOS/Xcode → Linux/GNU → Windows↔POSIX 边界 | 2 |
...
Phase2  01 C → 01.5 CMake → 02 计算机系统
          └ 01.7 三条工具链（Windows/MSVC ↔ macOS/Xcode ↔ Linux/GNU 互译；Mac 与 Pi 实测）
   ↓
