...
3. 确认 **swap 关闭 / 关键内存 mlock**；THP 策略与 [note-THP](../../06-linux-mm/chapter-03-page-table-management/notes/note-透明大页THP.md) 一致。
...
- LKD 内核笔记：[05-linux-kernel](../../05-linux-kernel/00_Book_3rd_Notes/)
