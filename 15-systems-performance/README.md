...
> **前置：** [02-CSAPP](../02-computer-systems/) · [19-Hennessy](../18-computer-architecture/) · 最好已有 **03–06** 系统基础  
> **下一本：** [17-BPF](../16-bpf-observability/)（紧接 13）  
...
**下一本（紧接）：** [16-bpf-observability](../16-bpf-observability/) — Ch 15 预览在此展开为 bpftrace/BCC 全书。
