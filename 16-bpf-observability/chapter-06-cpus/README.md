...
- [ ] **`runqlat` 是绑核健康度体温计**— dedicated 策略核右尾应极短；与 [SysPerf Ch6](../../15-systems-performance/chapter-06-cpus/) 一致。
...
- SysPerf CPU：[chapter-06-cpus](../../15-systems-performance/chapter-06-cpus/)
- SysPerf BPF 总览：[chapter-15-bpf](../../15-systems-performance/chapter-15-bpf/)
- 体系结构/cache：[19-Hennessy](../18-computer-architecture/) · [02-CSAPP Ch6](../02-computer-systems/chapter-06-memory-hierarchy/)
