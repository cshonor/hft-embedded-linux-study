...
- HFT 仓库内：[13-tcpip-protocols](../13-tcpip-protocols/) · [12-network-sockets](../12-network-sockets/) · [16-systems-performance](../16-systems-performance/)
...
| 主题 | 本模块章节 | 关联模块 |
|------|----------|---------|
| TCP/IP 协议细节 | ch07-ch09 | [13-tcpip-protocols](../13-tcpip-protocols/) |
| Socket 编程 | ch08 | [12-network-sockets](../12-network-sockets/) |
| 内核网络栈 | ch06 | [14-kernel-networking](../14-kernel-networking/) · [14.5-modern-networking](../14.5-modern-networking/) |
| 系统性能 | ch11 | [16-systems-performance](../16-systems-performance/) |
| eBPF 可观测性 | hft-05 | [17-bpf-observability](../17-bpf-observability/) |
| DPDK 内核旁路 | hft-03 | [15-dpdk](../15-dpdk/) |
